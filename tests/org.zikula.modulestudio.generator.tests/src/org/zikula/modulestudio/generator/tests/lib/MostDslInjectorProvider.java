/*
 * generated by Xtext see de.guite.modulestudio.mostdsl.tests/src-gen/MostDslInjectorProvider.java
 */
...
public class MostDslInjectorProvider implements IInjectorProvider, IRegistryConfigurator {
    ...
    protected static Injector internalCreateInjector() {
        return new MostDslStandaloneSetup().createInjectorAndDoEMFRegistration();
    }
