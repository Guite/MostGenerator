...
public class ConditionalExpression extends Expression {
    ...
    public static final ChildPropertyDescriptor IF_TRUE_PROPERTY = new ChildPropertyDescriptor(
            ConditionalExpression.class,
            "ifTrue", Expression.class, OPTIONAL, CYCLE_RISK); //$NON-NLS-1$
    public static final ChildPropertyDescriptor IF_FALSE_PROPERTY = new ChildPropertyDescriptor(
            ConditionalExpression.class,
            "ifFalse", Expression.class, MANDATORY, CYCLE_RISK); //$NON-NLS-1$
    ...
    public ConditionalExpression(int start, int end, AST ast,
        ...
        if (condition == null
                || (ast.apiLevel().isLessThan(PHPVersion.PHP5_3) && ifTrue == null)
                || ifFalse == null) {
    ...
    public void setIfTrue(Expression expression) {
        ...
        final ASTNode oldChild = this.ifTrue;
    ...
    public void setIfFalse(Expression expression) {
        ...
        final ASTNode oldChild = this.ifFalse;
    ...
    ASTNode clone0(AST target) {
        ...
        final Expression ifFalse = ASTNode
                .copySubtree(target, this.getIfTrue());
        final ConditionalExpression result = new ConditionalExpression(
                this.getStart(), this.getEnd(), target, condition, ifTrue,
                ifFalse);
        return result;
    }
