...
public class InterfaceDeclaration extends TypeDeclaration {
    ...
    private InterfaceDeclaration(int start, int end, AST ast,
            Identifier interfaceName, Identifier[] interfaces, Block body) {
        super(start, end, ast, interfaceName, interfaces, body);
    }

    public InterfaceDeclaration(int start, int end, AST ast,
            Identifier interfaceName, List interfaces, Block body) {
        this(start, end, ast, interfaceName, (Identifier[]) interfaces
    ...
    public void childrenAccept(Visitor visitor) {
        ...
        for (final Object node : interfaes) {
            final ASTNode inter = (ASTNode) node;
    ...
    ASTNode clone0(AST target) {
        ...
        final InterfaceDeclaration result = new InterfaceDeclaration(
                getStart(), getEnd(), target, name, interfaces, body);
        return result;
    }
