...
public class LocalStorageModelProvider extends StorageDocumentProvider
    ...
    private class InternalElementStateListener implements IElementStateListener {
        ...
        public void elementContentReplaced(Object element) {
            ...
            try {
                ...
                final CodedReaderCreator codedReaderCreator = new CodedReaderCreator(
                ...
                final int originalLengthToReplace = innerdocument.getLength();
                ...
                if (reader != null) {
                    try {
                        ...
                        GeneratorBeautifierPlugin.log(e1);
    ...
    private final IElementStateListener fInternalListener;
    /** IStructuredModel information of all connected elements */
    private final Map fModelInfoMap = new HashMap();
            ...
            if (storage != null) {
                ...
                if (storagePath != null) {
                    ...
                    if (!storagePath.lastSegment().equals(name)) {
                        final IPath workingPath = storagePath
    ...
    protected IAnnotationModel createAnnotationModel(Object element)
        ...
        if (element instanceof IStorageEditorInput) {
            final IStorageEditorInput input = (IStorageEditorInput) element;
            final String contentType = (getModel(input) != null ? getModel(
                    input).getContentTypeIdentifier() : null);
            final String ext = BreakpointRulerAction
                    .getFileExtension((IEditorInput) element);
            final IResource res = BreakpointProviderBuilder.getInstance()
    ...
    protected IDocument createDocument(Object element) {
        ...
        if (element instanceof IEditorInput) {
            ...
            final ModelInfo info = getModelInfoFor((IEditorInput) element);
            if (info == null) {
                throw new IllegalArgumentException(
                        "no corresponding model info found"); //$NON-NLS-1$
            }
            final IStructuredModel model = info.fStructuredModel;
            if (model != null) {
                if (!fReuseModelDocument
                    ...
                    try {
                        ...
                        final int originalLengthToReplace = innerdocument
                                .getLength();
    ...
    public void createModelInfo(IEditorInput input) {
        if (getModelInfoFor(input) == null) {
            final IStructuredModel structuredModel = selfCreateModel(input);
    ...
    public void createModelInfo(IEditorInput input,
        ...
        final ModelInfo modelInfo = new ModelInfo(structuredModel, input,
    ...
    protected void disposeElementInfo(Object element, ElementInfo info) {
        if (element instanceof IEditorInput) {
            ...
            final ModelInfo modelInfo = getModelInfoFor(input);
    ...
    public IStructuredModel getModel(IEditorInput element) {
        ...
        final ModelInfo info = getModelInfoFor(element);
        if (info != null) {
    ...
    private ModelInfo getModelInfoFor(IEditorInput element) {
        final ModelInfo result = (ModelInfo) fModelInfoMap.get(element);
        return result;
    }
    ...
    private ModelInfo getModelInfoFor(IStructuredModel structuredModel) {
        ...
        if (structuredModel != null) {
            final ModelInfo[] modelInfos = (ModelInfo[]) fModelInfoMap.values()
    ...
    public IStructuredModel loadModel(IStorageEditorInput input,
        ...
        final String id = calculateID(input);
        if (id == null) {
            return null;
        }
        ...
        } catch (final CoreException noStorageExc) {
            if (logExceptions) {
                GeneratorBeautifierPlugin.log(noStorageExc);
