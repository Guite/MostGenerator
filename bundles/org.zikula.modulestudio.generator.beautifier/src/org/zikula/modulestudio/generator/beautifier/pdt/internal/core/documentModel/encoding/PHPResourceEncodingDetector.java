package org.zikula.modulestudio.generator.beautifier.pdt.internal.core.documentModel.encoding;
 ...
 * 
 * 
 * Based on package org.eclipse.php.internal.core.documentModel.encoding;
 * 
 *******************************************************************************/
...
/*
 * The encoding is set by user preference and not by reading/parsing the
 * content.
...
public class PHPResourceEncodingDetector implements IResourceCharsetDetector {
    ...
    public EncodingMemento getEncodingMemento() throws IOException {
        final EncodingMemento fEncodingMemento = new EncodingMemento();
