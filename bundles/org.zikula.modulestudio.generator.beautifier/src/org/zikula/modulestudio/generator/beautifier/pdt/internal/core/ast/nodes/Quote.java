...
public class Quote extends Expression {
    ...
    public static final ChildListPropertyDescriptor EXPRESSIONS_PROPERTY = new ChildListPropertyDescriptor(
            Quote.class, "expressions", Expression.class, CYCLE_RISK); //$NON-NLS-1$
    public static final SimplePropertyDescriptor QUOTE_TYPE_PROPERTY = new SimplePropertyDescriptor(
            Block.class, "quoteType", Integer.class, OPTIONAL); //$NON-NLS-1$
    ...
    ASTNode clone0(AST target) {
        ...
        final Quote result = new Quote(this.getStart(), this.getEnd(), target,
                expressions, type);
        return result;
    }
