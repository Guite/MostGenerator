...
public class ReflectionArrayVariableReference extends
    ...
    public ReflectionArrayVariableReference(int start, int end,
            Expression name, Expression index, int arrayType) {
