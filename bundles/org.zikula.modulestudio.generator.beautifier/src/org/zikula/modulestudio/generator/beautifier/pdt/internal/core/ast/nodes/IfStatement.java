...
public class IfStatement extends Statement {
    ...
    public static final ChildPropertyDescriptor TRUE_STATEMENT_PROPERTY = new ChildPropertyDescriptor(
            IfStatement.class,
    ...
    public static final ChildPropertyDescriptor FALSE_STATEMENT_PROPERTY = new ChildPropertyDescriptor(
            IfStatement.class,
            "falseStatement", Statement.class, OPTIONAL, CYCLE_RISK); //$NON-NLS-1$
    ...
    public IfStatement(int start, int end, AST ast, Expression condition,
    ...
    public void setCondition(Expression expression) {
        ...
        final ASTNode oldChild = this.condition;
    ...
    public void setTrueStatement(Statement statement) {
        ...
        final ASTNode oldChild = this.trueStatement;
    ...
    public void setFalseStatement(Statement statement) {
        final ASTNode oldChild = this.falseStatement;
    ...
    ASTNode clone0(AST target) {
        final Expression condition = ASTNode
                .copySubtree(target, getCondition());
        final Statement trueStatement = ASTNode.copySubtree(target,
                getTrueStatement());
        final Statement falseStatement = ASTNode.copySubtree(target,
                getFalseStatement());

        final IfStatement result = new IfStatement(this.getStart(),
                this.getEnd(), target, condition, trueStatement, falseStatement);
        return result;
    }
