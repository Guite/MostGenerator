package org.zikula.modulestudio.generator.beautifier.pdt.internal.ui.text;
 ...
 * 
 * 
 * Based on package org.eclipse.php.internal.ui.text;
 * 
 *******************************************************************************/
...
import org.zikula.modulestudio.generator.beautifier.pdt.internal.ui.editor.PHPPairMatcher;
...
public class PHPDocumentRegionEdgeMatcher extends DocumentRegionEdgeMatcher {
    ...
    public IRegion match(IDocument document, int offset) {
        ...
        if (!fRegionTypes.isEmpty() && document instanceof IStructuredDocument) {
            final IStructuredDocumentRegion docRegion = ((IStructuredDocument) document)
            ...
            if (docRegion != null) {
                ...
                if (match == null) {
                    ...
                    if (currentTextRegion instanceof ITextRegionContainer) {
                        final ITextRegionContainer container = (ITextRegionContainer) currentTextRegion;
                        currentTextRegion = container
                                .getRegionAtCharacterOffset(offset);
                    }
                    if (currentTextRegion instanceof IPhpScriptRegion) {
                        final IPhpScriptRegion scriptRegion = (IPhpScriptRegion) currentTextRegion;
                        try {
        ...
        try {
            ...
            if (match != null && match.getLength() == 1) {
                final char currChar = document.getChar(match.getOffset());
