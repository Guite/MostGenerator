...
import org.zikula.modulestudio.generator.beautifier.pdt.internal.core.ast.locator.Locator;
...
public class Program extends ASTNode {
    ...
    public void childrenAccept(Visitor visitor) {
        for (final ASTNode node : this.statements) {
            node.accept(visitor);
        }
        for (final ASTNode node : this.comments) {
            node.accept(visitor);
        }
    }
    ...
    public void toString(StringBuffer buffer, String tab) {
        ...
        for (final ASTNode comment : this.comments) {
    ...
    public ASTNode findDeclaringNode(IBinding binding) {
        final ISourceReference phpElement = (ISourceReference) binding
                .getPHPElement();
        try {
