...
public interface PHPVariableKind extends VariableKind {
    ...
    public class PHPImplementation extends Implementation implements
            PHPVariableKind {
     ...
     */
    public static final PHPVariableKind LOCAL = new PHPImplementation(
            VariableKind.LOCAL);

    /**
     * Variable, like: <code>$name</code> anywhere in global scope
     */
    public static final PHPVariableKind GLOBAL = new PHPImplementation(
            VariableKind.GLOBAL);

    /**
     * Instance variable, like: <code>$obj->var</code>
     */
    public static final PHPVariableKind INSTANCE = new PHPImplementation(
            VariableKind.INSTANCE);

    /**
     * Class variable, like: <code>DAO::$instance</code>
     */
    public static final PHPVariableKind CLASS = new PHPImplementation(
            VariableKind.CLASS);

    /**
     * Constant, like: <code>E_ALL</code>
     */
    public static final PHPVariableKind CONSTANT = new PHPImplementation(
            VariableKind.GLOBAL);
