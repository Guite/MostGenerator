...
public class DOMDocumentForPHP extends DocumentStyleImpl {
    ...
    public Node cloneNode(boolean deep) {
        final DOMDocumentForPHP cloned = new DOMDocumentForPHP(this);
        if (deep) {
    ...
    public Element createElement(String tagName) throws DOMException {
        ...
        final ElementImplForPhp element = new ElementImplForPhp();
    ...
    public Attr createAttribute(String name) throws DOMException {
        final AttrImplForPhp attr = new AttrImplForPhp();
    ...
    public Text createTextNode(String data) {
        final TextImplForPhp text = new TextImplForPhp();
