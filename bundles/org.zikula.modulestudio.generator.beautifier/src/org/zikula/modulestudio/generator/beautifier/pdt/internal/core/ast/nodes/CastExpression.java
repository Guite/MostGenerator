...
public class CastExpression extends Expression {
    ...
    public CastExpression(int start, int end, AST ast, Expression expr,
            int castType) {
        super(start, end, ast);
    ...
    ASTNode clone0(AST target) {
        final Expression clone = ASTNode.copySubtree(target,
                this.getExpression());
        final CastExpression result = new CastExpression(this.getStart(),
                this.getEnd(), target, clone, this.getCastingType());
        return result;
    }
