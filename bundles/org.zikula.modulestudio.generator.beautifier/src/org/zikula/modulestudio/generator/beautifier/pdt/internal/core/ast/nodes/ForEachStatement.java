...
public class ForEachStatement extends Statement {
    ...
    public static final ChildPropertyDescriptor STATEMENT_PROPERTY = new ChildPropertyDescriptor(
            ForEachStatement.class,
    ...
    public ForEachStatement(int start, int end, AST ast, Expression expression,
    ...
    public void setExpression(Expression expression) {
        ...
        final ASTNode oldChild = this.expression;
    ...
    public void setKey(Expression key) {
        final ASTNode oldChild = this.key;
    ...
    public void setStatement(Statement statement) {
        ...
        final ASTNode oldChild = this.statement;
    ...
    ASTNode clone0(AST target) {
        ...
        final ForEachStatement result = new ForEachStatement(this.getStart(),
                this.getEnd(), target, expr, key, value, stm);
        return result;
    }
