...
public class ArrayAccess extends Variable {
    ...
    public static final ChildPropertyDescriptor NAME_PROPERTY = new ChildPropertyDescriptor(
            ArrayAccess.class,
            "name", VariableBase.class, MANDATORY, CYCLE_RISK); //$NON-NLS-1$
    public static final SimplePropertyDescriptor DOLLARED_PROPERTY = new SimplePropertyDescriptor(
            ArrayAccess.class, "isDollared", Boolean.class, OPTIONAL); //$NON-NLS-1$
    public static final ChildPropertyDescriptor INDEX_PROPERTY = new ChildPropertyDescriptor(
            ArrayAccess.class, "index", Expression.class, OPTIONAL, CYCLE_RISK); //$NON-NLS-1$
    public static final SimplePropertyDescriptor ARRAY_TYPE_PROPERTY = new SimplePropertyDescriptor(
            ArrayAccess.class, "arrayType", Integer.class, OPTIONAL); //$NON-NLS-1$
    ...
    public ArrayAccess(int start, int end, AST ast, VariableBase variableName,
    ...
    public void setIndex(Expression index) {
        ...
        final ASTNode oldChild = this.index;
    ...
    ASTNode clone0(AST target) {
        ...
        final ArrayAccess result = new ArrayAccess(getStart(), getEnd(),
                target, expr, index, type);
        return result;
    }
