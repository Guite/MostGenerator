package org.zikula.modulestudio.generator.beautifier.pdt.internal.core.ast.scanner;
 ...
 * 
 * 
 * Based on package org.eclipse.php.internal.core.ast.scanner;
 * 
 *******************************************************************************/
...
public class StateStack implements Cloneable {
    ...
    public StateStack createClone() {
        final StateStack rv = new StateStack(this.size());
        rv.copyFrom(this);
        return rv;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final StateStack s2 = (StateStack) obj;
