...
public class SwitchStatement extends Statement {
    ...
    public SwitchStatement(int start, int end, AST ast, Expression expression,
            Block body) {
        super(start, end, ast);
    ...
    ASTNode clone0(AST target) {
        ...
        final SwitchStatement result = new SwitchStatement(this.getStart(),
                this.getEnd(), target, expr, body);
        return result;
    }
