...
public class Tree {
  ...
  private CharSequence selectTree(final Entity it) {
    ...
    _builder.newLine();
    _builder.append("    ");
    _builder.append("return array_merge([$rootNode], $children);");
    _builder.newLine();
    _builder.append("}");
    _builder.newLine();
    return _builder;
  ...
  private CharSequence selectAllTrees(final Entity it) {
    ...
    _builder.newLine();
    _builder.append("    ");
    _builder.append("$qb = $this->genericBaseQuery(\'tbl.lvl:eq:0\', \'\', $useJoins, $slimMode);");
    _builder.newLine();
    _builder.append("    ");
    ...
    _builder.newLine();
    _builder.append("        ");
    _builder.append("$trees[$rootNode->getId()] = array_merge([$rootNode], $children);");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("}");
    _builder.newLine();
