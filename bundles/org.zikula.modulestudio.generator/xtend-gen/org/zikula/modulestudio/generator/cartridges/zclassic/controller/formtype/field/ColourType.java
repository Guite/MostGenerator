...
public class ColourType {
  ...
  public void generate(final Application it, final IFileSystemAccess fsa) {
    ...
    String _plus = (_appSourceLibPath + "Form/Type/Field/ColourType.php");
    this._namingExtensions.generateClassPair(it, fsa, _plus, 
      this.fh.phpFileContent(it, this.colourTypeBaseImpl(it)), this.fh.phpFileContent(it, this.colourTypeImpl(it)));
  }
  
  private CharSequence colourTypeBaseImpl(final Application it) {
    ...
    _builder.newLine();
    _builder.append(" ");
    _builder.append("* Colour field type base class.");
    _builder.newLine();
    _builder.append(" ");
    _builder.append("*");
    _builder.newLine();
    ...
    _builder.append("*/");
    _builder.newLine();
    _builder.append("abstract class AbstractColourType extends AbstractType");
    _builder.newLine();
    _builder.append("{");
    _builder.newLine();
    _builder.append("    ");
    ...
    _builder.newLine();
    _builder.append("                ");
    _builder.append("\'maxlength\' => 7,");
    _builder.newLine();
    _builder.append("                ");
    _builder.append("\'class\' => \'colour-selector\'");
    _builder.newLine();
    _builder.append("            ");
    _builder.append("]");
    _builder.newLine();
  ...
  private CharSequence colourTypeImpl(final Application it) {
    StringConcatenation _builder = new StringConcatenation();
    _builder.append("namespace ");
    String _appNamespace = this._utils.appNamespace(it);
    _builder.append(_appNamespace);
    ...
    _builder.append("\\Form\\Type\\Field\\Base\\AbstractColourType;");
    _builder.newLineIfNotEmpty();
    _builder.newLine();
    _builder.append("/**");
    _builder.newLine();
    _builder.append(" ");
    _builder.append("* Colour field type implementation class.");
    _builder.newLine();
    _builder.append(" ");
    _builder.append("*");
    _builder.newLine();
    ...
    _builder.append("*/");
    _builder.newLine();
    _builder.append("class ColourType extends AbstractColourType");
    _builder.newLine();
    _builder.append("{");
    _builder.newLine();
    _builder.append("    ");
