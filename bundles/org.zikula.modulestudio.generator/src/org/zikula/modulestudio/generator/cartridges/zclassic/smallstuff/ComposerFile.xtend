...
class ComposerFile {
    ...
    def private composerContent(Application it) '''
        ...
        "version": "«version»",
        "description": "«IF null !== documentation && documentation != ''»«documentation.replace('"', "'").formatForDisplayCapital»«ELSE»«appName» module generated by ModuleStudio «msVersion».«ENDIF»",
        "type": "zikula-module",
        "license": "«licenseSPDX»",
        "authors": [
            {
        ...
        "extra": {
            "zikula": {
                "core-compatibility": ">=«IF targets('1.5')»1.5.0«ELSE»1.4.6«ENDIF» <3.0",
