...
class UrlRoutingLegacy {
    ...
    def private routerFacadeBaseImpl(Application it) '''
        ...
        «ENDIF»
        {
            ...
            «IF targets('1.3.x')»
                «fh.getterAndSetterMethods(it, 'router', 'Zikula_Routing_UrlRouter', false, true, true, 'null', '')»
            «ELSE»
                «fh.getterAndSetterMethods(it, 'router', '\\Zikula\\Routing\\UrlRouter', false, true, true, 'null', '')»
            «ENDIF»
        }
    '''
