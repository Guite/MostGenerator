...
class TravisFile {
    ...
    def private travisFile(Application it) '''
        ...
        install:
            ...
            - zip -qr «appName».zip .
            «IF targets('1.4-dev')»
            - wget http://ci.zikula.org/job/Zikula_Core-1.4.6/106/artifact/build/archive/Zikula_Core-1.4.6.build106.tar.gz
            - tar -xpzf Zikula_Core-1.4.6.build106.tar.gz
            - rm Zikula_Core-1.4.6.build106.tar.gz
