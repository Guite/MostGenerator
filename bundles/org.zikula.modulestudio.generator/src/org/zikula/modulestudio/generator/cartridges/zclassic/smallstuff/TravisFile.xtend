...
class TravisFile {
    ...
    def private travisFile(Application it) '''
        ...
        install:
            - composer install
            - zip -qr «appName».zip .
            - wget https://github.com/zikula/core/releases/download/1.4.3-rc2/Zikula_Core-1.4.3.build178.tar.gz
            - tar -xpzf Zikula_Core-1.4.3.build178.tar.gz
            - rm Zikula_Core-1.4.3.build178.tar.gz
