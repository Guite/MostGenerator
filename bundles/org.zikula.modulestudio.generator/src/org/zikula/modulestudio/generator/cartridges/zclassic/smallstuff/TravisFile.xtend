...
class TravisFile {
    ...
    def private travisFile(Application it) '''
        ...
        install:
            ...
            «ELSE»
            - wget http://ci.zikula.org/job/Zikula_Core-1.4.7/153/artifact/build/archive/Zikula_Core-1.4.7.build153.tar.gz
            ...
            «IF isSystemModule»
                ...
                - mysql -e "INSERT INTO zk_test.modules (id, name, type, displayname, url, description, directory, version, capabilities, state, securityschema, core_min, core_max) VALUES (NULL, '«appName»', '3', '«name.formatForDisplayCapital»', '«name.formatForDB»', '«IF null !== documentation && documentation != ''»«documentation.replace('"', "'")»«ELSE»«appName» module generated by ModuleStudio «msVersion».«ENDIF»', '«appName»', '«version»', 'N;', '3', 'N;', '«IF targets('2.0')»2.0.0«ELSEIF targets('1.5')»1.5.0«ELSE»1.4.6«ENDIF»', '3.0.0');"
            «ELSE»
                - cd modules
