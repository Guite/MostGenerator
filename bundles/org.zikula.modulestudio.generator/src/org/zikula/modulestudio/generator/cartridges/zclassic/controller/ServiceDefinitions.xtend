...
class ServiceDefinitions {
    ...
    def private servicesHelper(Application it) '''
        ...
        «IF needsApproval»
            ...
            «modPrefix».notification_helper:
                ...
                arguments: ["@translator.default", "@session", "@router", "@zikula_extensions_module.api.variable", "@zikula_users_module.current_user", "@ŧwig", "@zikula_mailer_module.api.mailer", "@«modPrefix».workflow_helper"]
        «ENDIF»
        «IF hasTranslatable»
    ...
    def private servicesTwig(Application it) '''
        ...
        «modPrefix».twig_extension:
            ...
            arguments: ["@translator.default"«IF hasTrees», "@router"«ENDIF», "@zikula_extensions_module.api.variable", "@«modPrefix».workflow_helper"«IF hasUploads», "@«modPrefix».view_helper"«ENDIF»«IF hasListFields», "@«modPrefix».listentries_helper"«ENDIF»]
            public: false
            tags:
                - { name: twig.extension }
    '''
