    ...
    def private servicesHelper(Application it) '''
        ...
        «IF hasCategorisableEntities»
            «modPrefix».category_helper:
                ...
                arguments: ["@service_container", "@translator.default", "@session", "@logger", "@request_stack", "@zikula_users_module.current_user"«IF targets('1.4-dev')», "@zikula_categories_module.api.category_registry"«ENDIF»]
