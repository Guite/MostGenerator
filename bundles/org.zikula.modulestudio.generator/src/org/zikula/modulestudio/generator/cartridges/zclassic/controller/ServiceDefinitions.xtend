    ...
    def private servicesHelper(Application it) '''
        ...
        «IF needsApproval»
            ...
            «modPrefix».notification_helper:
                ...
                arguments: ["@translator.default", "@session", "@router", "@zikula_extensions_module.api.variable", "@zikula_users_module.current_user", "@twig", "@zikula_mailer_module.api.mailer", "@«modPrefix».workflow_helper"]
        «ENDIF»
        «IF hasTranslatable»
