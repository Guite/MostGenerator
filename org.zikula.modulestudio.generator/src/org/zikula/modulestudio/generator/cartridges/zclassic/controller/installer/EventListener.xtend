...
class EventListener {
    ...
    def generate(Application it) '''
        ...
        {
            // core
            «var callableClass = appName + '_Listener_Core'»
            ...
            // installer
            «callableClass = appName + '_Listener_Installer'»
            ...
            // modules
            «callableClass = appName + '_Listener_ModuleDispatch'»
            ...
            // errors
            «callableClass = appName + '_Listener_Errors'»
            ...
            // theme
            «callableClass = appName + '_Listener_Theme'»
            ...
            // view
            «callableClass = appName + '_Listener_View'»
            ...
            // user login
            «callableClass = appName + '_Listener_UserLogin'»
            ...
            // registration
            «callableClass = appName + '_Listener_UserRegistration'»
            ...
            «callableClass = appName + '_Listener_ThirdParty'»
