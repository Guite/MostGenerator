...
class Tests {
    ...
    def generate(Application it, IFileSystemAccess fsa) {
        ...
        fsa.generateFile(testsPath + 'ClassLoaderTests.php', classLoaderTestsFile)
    }
    ...
    def private classLoaderFile(Application it) '''
    	«fh.phpFileHeader(it)»
    	«classLoaderImpl»
    '''

    def private classLoaderTestsFile(Application it) '''
    	«fh.phpFileHeader(it)»
    	«classLoaderTestsImpl»
    '''
    ...
    def private classLoaderImpl(Application it) '''
        /**
    ...
    def private classLoaderTestsImpl(Application it) '''
