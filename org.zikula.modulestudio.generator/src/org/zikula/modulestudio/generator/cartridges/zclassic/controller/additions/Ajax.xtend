    ...
    def additionalAjaxFunctions(AjaxController it, Application app) '''
        ...
        «IF !joinRelations.isEmpty»
            ...
            public function getItemList()
            {
                ...
                if (!in_array($objectType, «app.appName»_Util_Controller::getObjectTypes('controllerAction', array('controller' => '«formattedName»', 'action' => 'getItemList')))) {
                    $objectType = «app.appName»_Util_Controller::getDefaultObjectType('controllerAction', array('controller' => '«formattedName»', 'action' => 'getItemList'));
                }
