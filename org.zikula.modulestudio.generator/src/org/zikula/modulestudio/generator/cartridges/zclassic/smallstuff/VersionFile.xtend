    ...
    def private appInfoBaseImpl(Application it) '''
        ...
        class «IF targets('1.3.5')»«appName»_Base_«ELSE»«name.formatForCodeCapital»Module«ENDIF»Version extends Zikula_AbstractVersion
        {
            ...
            public function getMetaData()
            {
                ...
                $meta['description']          = $this->__('«IF documentation !== null && documentation != ''»«documentation.replaceAll("'", "\\'")»«ELSE»«name.formatForDisplayCapital» module generated by ModuleStudio «msVersion».«ENDIF»');
