        ...
        <body>
            ...
            <div>
                ...
                <fieldset>
                    ...
                    <div class="z-formrow">
                        <label for="«app.appName»_sort">{gt text='Sort by'}:</label>
                        <select id="«app.appName»_sort" name="sort" style="width: 150px" class="z-floatleft" style="margin-right: 10px">
                        ...
                        <select id="«app.appName»_sortdir" name="sortdir" style="width: 100px">
                    ...
                    <div class="z-formrow">
                        <label for="«app.appName»_pagesize">{gt text='Page size'}:</label>
                        <select id="«app.appName»_pagesize" name="num" style="width: 50px; text-align: right">
                    ...
                    «IF hasAbstractStringFieldsEntity»
                        <div class="z-formrow">
                            <label for="«app.appName»_searchterm">{gt text='Search for'}:</label>
                            <input type="text" id="«app.appName»_searchterm" name="searchterm" style="width: 150px" class="z-floatleft" style="margin-right: 10px" />
                            <input type="button" id="«app.appName»_gosearch" name="gosearch" value="{gt text='Filter'}" style="width: 80px" />
                        </div>
                    ...
                    <input type="submit" id="«app.appName»_submit" name="submitButton" value="{gt text='Change selection'}" />
    ...
    def private selectTemplate(Entity it, Application app) '''
        ...
        «IF hasAbstractStringFieldsEntity»
            <p>
                ...
                <input type="button" id="«app.appName»_gosearch" name="gosearch" value="{gt text='Filter'}" />
                <br{$break} />
            </p>
        «ENDIF»
        <br />
