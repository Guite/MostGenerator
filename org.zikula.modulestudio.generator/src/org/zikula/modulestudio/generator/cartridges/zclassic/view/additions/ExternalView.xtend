...
class ExternalView {
    ...
    def private itemInfoTemplate(Entity it, Application app) '''
        ...
        <dt>{$«name.formatForCode»->getTitleFromDisplayPattern()«IF !skipHookSubscribers»|notifyfilters:'«app.name.formatForDB».filter_hooks.«nameMultiple.formatForDB».filter'«ENDIF»|htmlentities}</dt>
        «IF hasImageFieldsEntity»
        ...
        «ENDIF»
            ...
            <div>
                ...
                <fieldset>
                    ...
                    <input type="button" id="«app.appName.toFirstLower»Cancel" name="cancelButton" value="{gt text='Cancel'}"«IF !app.targets('1.3.x')» class="btn btn-default"«ENDIF» />
                    <br />
                </fieldset>
            </div>
            </form>
        ...
        «IF categorisable»
            ...
            {if $properties ne null && is_array($properties)}
                ...
                {foreach key='propertyName' item='propertyId' from=$properties}
                    <div class="«IF app.targets('1.3.x')»z-formrow«ELSE»form-group«ENDIF» categoryselector">
                        ...
                        {/if}
                        <label for="{$categorySelectorId}{$propertyName}"«IF !app.targets('1.3.x')» class="col-sm-3 control-label"«ENDIF»>{$categoryLabel}</label>
                        «IF !app.targets('1.3.x')»
                            <div class="col-sm-9">
                        «ELSE»
                            &nbsp;
                        «ENDIF»
                            ...
                            <span class="«IF app.targets('1.3.x')»z-sub z-formnote«ELSE»help-block«ENDIF»">{gt text='This is an optional filter.'}</span>
                        «IF !app.targets('1.3.x')»
                            </div>
                        «ENDIF»
                    </div>
    ...
    def private findTemplatePasteAs(Entity it, Application app) '''
        <div class="«IF app.targets('1.3.x')»z-formrow«ELSE»form-group«ENDIF»">
            <label for="«app.appName.toFirstLower»PasteAs"«IF !app.targets('1.3.x')» class="col-sm-3 control-label"«ENDIF»>{gt text='Paste as'}:</label>
            «IF !app.targets('1.3.x')»
                <div class="col-sm-9">
            «ENDIF»
    ...
    def private findTemplateObjectId(Entity it, Application app) '''
        <div class="«IF app.targets('1.3.x')»z-formrow«ELSE»form-group«ENDIF»">
            <label for="«app.appName.toFirstLower»ObjectId"«IF !app.targets('1.3.x')» class="col-sm-3 control-label"«ENDIF»>{gt text='«name.formatForDisplayCapital»'}:</label>
            «IF !app.targets('1.3.x')»
                <div class="col-sm-9">
            «ENDIF»
    ...
    def private findTemplateSorting(Entity it, Application app) '''
        <div class="«IF app.targets('1.3.x')»z-formrow«ELSE»form-group«ENDIF»">
            <label for="«app.appName.toFirstLower»Sort"«IF !app.targets('1.3.x')» class="col-sm-3 control-label"«ENDIF»>{gt text='Sort by'}:</label>
            «IF !app.targets('1.3.x')»
                <div class="col-sm-9">
            «ENDIF»
    ...
    def private findTemplatePageSize(Entity it, Application app) '''
        <div class="«IF app.targets('1.3.x')»z-formrow«ELSE»form-group«ENDIF»">
            <label for="«app.appName.toFirstLower»PageSize"«IF !app.targets('1.3.x')» class="col-sm-3 control-label"«ENDIF»>{gt text='Page size'}:</label>
            «IF !app.targets('1.3.x')»
                <div class="col-sm-9">
            «ENDIF»
    ...
    def private findTemplateSearch(Entity it, Application app) '''
        «IF hasAbstractStringFieldsEntity»
            <div class="«IF app.targets('1.3.x')»z-formrow«ELSE»form-group«ENDIF»">
                <label for="«app.appName.toFirstLower»SearchTerm"«IF !app.targets('1.3.x')» class="col-sm-3 control-label"«ENDIF»>{gt text='Search for'}:</label>
            «IF !app.targets('1.3.x')»
                <div class="col-sm-9">
            «ENDIF»
