...
class Docs {
    ...
    def generate(Application it, IFileSystemAccess fsa) {
        fsa.generateFile('README.markdown', ReadmeMarkup)
        val docPath = getAppSourcePath(appName) + 'docs/'
        fsa.generateFile(docPath + 'credits.txt', Credits)
        fsa.generateFile(docPath + 'changelog.txt', Changelog)
        fsa.generateFile(docPath + 'developers.txt', new DeveloperHints().generate(it))
        fsa.generateFile(docPath + 'doctrine.txt', DoctrineHints)
        fsa.generateFile(docPath + 'modulestudio.txt', MostText)
        fsa.generateFile(docPath + 'readme_de.txt', ReadmeDE)
        fsa.generateFile(docPath + 'readme.txt', Readme)
        fsa.generateFile(docPath + 'license.txt', License)
    }
