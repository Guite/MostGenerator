...
public class View {
  ...
  public CharSequence generate(final Application it, final Boolean isBase) {
    ...
    _builder.newLine();
    _builder.append(" ");
    _builder.append("* Listener for the `view.init` event.");
    _builder.newLine();
    _builder.append(" ");
    _builder.append("*");
    _builder.newLine();
    _builder.append(" ");
    _builder.append("* Occurs just before `Zikula_View#__construct()` finishes.");
    _builder.newLine();
    _builder.append(" ");
    _builder.append("* The subject is the Zikula_View instance.");
    _builder.newLine();
    _builder.append(" ");
    _builder.append("*");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append(" ");
    _builder.append("* Listener for the `view.postfetch` event.");
    _builder.newLine();
    _builder.append(" ");
    _builder.append("*");
    _builder.newLine();
    _builder.append(" ");
    _builder.append("* Filter of result of a fetch.");
    _builder.newLine();
    _builder.append(" ");
    _builder.append("* Receives `Zikula_View` instance as subject,");
    _builder.newLine();
    _builder.append(" ");
    _builder.append("* args are `array(\'template\' => $template)`,");
    _builder.newLine();
    _builder.append(" ");
    _builder.append("* $data was the result of the fetch to be filtered.");
    _builder.newLine();
    _builder.append(" ");
    _builder.append("*");
    _builder.newLine();
