...
public class FormHandler {
  ...
  private CharSequence formHandlerCommonImpl(final Controller it, final String actionName) {
    ...
    _builder.newLineIfNotEmpty();
    {
      ...
      if (_not) {
        ...
        String _formatForCodeCapital_2 = this._formattingExtensions.formatForCodeCapital(actionName);
        _builder.append(_formatForCodeCapital_2, "");
        _builder.append("Handler as Base");
        String _formatForCodeCapital_3 = this._formattingExtensions.formatForCodeCapital(actionName);
        _builder.append(_formatForCodeCapital_3, "");
        _builder.append("Handler;");
        _builder.newLineIfNotEmpty();
  ...
  private CharSequence formHandlerBaseImpl(final Entity it, final String actionName) {
    ...
    String _plus_1 = (_plus + _formattedName_1);
    String _plus_2 = (_plus_1 + "_");
    String _plus_3 = (_plus_2 + actionName);
    String _formatForCode = this._formattingExtensions.formatForCode(_plus_3);
    _builder.append(_formatForCode, " ");
    ...
    _builder.newLine();
    {
      ...
      if (_targets_2) {
        ...
        String _formatForCodeCapital_5 = this._formattingExtensions.formatForCodeCapital(_name_4);
        _builder.append(_formatForCodeCapital_5, "");
        _builder.append("_Base_");
        ...
        _builder.append(_formatForCodeCapital_9, "");
        _builder.append("Handler extends Base");
        String _formatForCodeCapital_10 = this._formattingExtensions.formatForCodeCapital(actionName);
  ...
  private CharSequence formHandlerImpl(final Entity it, final String actionName) {
    ...
    _builder.newLineIfNotEmpty();
    {
      ...
      if (_not) {
        ...
        _builder.append(_appNamespace_1, "");
        _builder.append("\\Form\\Handler\\");
        String _name_2 = this.controller.getName();
    ...
    _builder.newLine();
    {
      ...
      if (_targets_1) {
        ...
        _builder.append("_Form_Handler_");
        String _name_5 = this.controller.getName();
        String _formatForCodeCapital_6 = this._formattingExtensions.formatForCodeCapital(_name_5);
        _builder.append(_formatForCodeCapital_6, "");
        _builder.append("_");
        String _name_6 = it.getName();
        String _formatForCodeCapital_7 = this._formattingExtensions.formatForCodeCapital(_name_6);
        _builder.append(_formatForCodeCapital_7, "");
        _builder.append("_");
        String _formatForCodeCapital_8 = this._formattingExtensions.formatForCodeCapital(actionName);
        _builder.append(_formatForCodeCapital_8, "");
        ...
        _builder.append(_appName_2, "");
        _builder.append("_Form_Handler_");
        String _name_7 = this.controller.getName();
        String _formatForCodeCapital_9 = this._formattingExtensions.formatForCodeCapital(_name_7);
        _builder.append(_formatForCodeCapital_9, "");
        _builder.append("_");
        String _name_8 = it.getName();
        String _formatForCodeCapital_10 = this._formattingExtensions.formatForCodeCapital(_name_8);
        _builder.append(_formatForCodeCapital_10, "");
        _builder.append("_Base_");
        String _formatForCodeCapital_11 = this._formattingExtensions.formatForCodeCapital(actionName);
        _builder.append(_formatForCodeCapital_11, "");
        _builder.newLineIfNotEmpty();
      } else {
        _builder.append("class ");
        String _formatForCodeCapital_12 = this._formattingExtensions.formatForCodeCapital(actionName);
        _builder.append(_formatForCodeCapital_12, "");
        _builder.append("Handler extends Base");
        String _formatForCodeCapital_13 = this._formattingExtensions.formatForCodeCapital(actionName);
