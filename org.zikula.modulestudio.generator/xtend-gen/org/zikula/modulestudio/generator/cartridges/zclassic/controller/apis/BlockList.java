  ...
  private CharSequence listBlockBaseImpl(final Application it) {
    ...
    _builder.newLine();
    {
      ...
      if (_hasCategorisableEntities_3) {
        ...
        _builder.append("\', \'category\', \'buildFilterClauses\', array(\'qb\' => $qb, \'ot\' => $objectType, \'catids\' => $vars[\'catIds\']));");
        _builder.newLineIfNotEmpty();
        _builder.append("    ");
        _builder.append("    ");
        _builder.append("}");
    ...
    _builder.newLine();
    _builder.append("    ");
    _builder.append("list($query, $count) = $repository->getSelectWherePaginatedQuery($qb, $currentPage, $resultsPerPage);");
    _builder.newLine();
    _builder.append("    ");
