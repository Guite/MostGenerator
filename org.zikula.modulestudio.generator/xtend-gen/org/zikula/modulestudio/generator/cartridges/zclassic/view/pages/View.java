...
public class View {
  ...
  private CharSequence viewView(final Entity it, final String appName, final Controller controller) {
    ...
    _builder.append(objName, "    ");
    _builder.append("\'}\" title=\"{$linkTitle}\" class=\"");
    {
    ...
    _builder.append("\' func=\'view\' ot=\'");
    _builder.append(objName, "    ");
    _builder.append("\' all=1}\" title=\"{$linkTitle}\" class=\"");
    {
    ...
    _builder.newLine();
    {
      ...
      if (_notEquals_3) {
        ...
        _builder.append("\' func=\'view\' ot=\'");
        _builder.append(objName, "");
        _builder.append("\' tpl=\'tree\'}\" title=\"{$linkTitle}\" class=\"");
        {
          ...
          if (_targets_5) {
            ...
            _builder.append("icon icon-code-fork");
          }
        }
        _builder.append("\">{$linkTitle}</a>");
        _builder.newLineIfNotEmpty();
          ...
          if (_hasBooleansWithAjaxToggleEntity_1) {
            ...
            _builder.newLineIfNotEmpty();
            {
              ...
              for(final BooleanField field : _booleansWithAjaxToggleEntity) {
                ...
                String _prefix = _application_8.getPrefix();
      ...
      if (_tripleNotEquals_2) {
        ...
        _builder.newLine();
        {
          ...
          if (_targets) {
            ...
            Models _container_4 = it.getContainer();
            Application _application_4 = _container_4.getApplication();
            String _appName_2 = this._utils.appName(_application_4);
            _builder.append(_appName_2, "    ");
            _builder.append("\' type=\'");
            String _formattedName_2 = this._controllerExtensions.formattedName(linkController);
            _builder.append(_formattedName_2, "    ");
            _builder.append("\' ");
            String _modUrlDisplay_2 = this._urlExtensions.modUrlDisplay(linkEntity, relObjName, Boolean.valueOf(true));
        ...
        Models _container_5 = it.getContainer();
        Application _application_5 = _container_5.getApplication();
        String _prefix = _application_5.getPrefix();
        _builder.append(_prefix, "            ");
        _builder.append("InitInlineWindow($(\'");
        String _name_11 = linkEntity.getName();
        String _formatForCode_10 = this._formattingExtensions.formatForCode(_name_11);
        _builder.append(_formatForCode_10, "            ");
        _builder.append("Item");
        {
          Iterable<DerivedField> _primaryKeyFields_4 = this._modelExtensions.getPrimaryKeyFields(mainEntity);
          ...
          for(final DerivedField pkField_4 : _primaryKeyFields_4) {
            ...
            _builder.append("{{$");
            String _name_12 = mainEntity.getName();
            String _formatForCode_11 = this._formattingExtensions.formatForCode(_name_12);
            _builder.append(_formatForCode_11, "            ");
            _builder.append(".");
            String _name_13 = pkField_4.getName();
            String _formatForCode_12 = this._formattingExtensions.formatForCode(_name_13);
        ...
        _builder.append("_rel_");
        {
          Iterable<DerivedField> _primaryKeyFields_5 = this._modelExtensions.getPrimaryKeyFields(linkEntity);
          ...
          for(final DerivedField pkField_5 : _primaryKeyFields_5) {
            ...
            _builder.append(relObjName, "            ");
            _builder.append(".");
            String _name_14 = pkField_5.getName();
            String _formatForCode_13 = this._formattingExtensions.formatForCode(_name_14);
        ...
        _builder.append("Display\'), \'{{");
        {
          ...
          if (_tripleNotEquals_3) {
            ...
            String _formatForCode_14 = this._formattingExtensions.formatForCode(_name_15);
            _builder.append(_formatForCode_14, "            ");
          } else {
            _builder.append("gt text=\'");
            String _name_16 = linkEntity.getName();
            String _formatForDisplayCapital_1 = this._formattingExtensions.formatForDisplayCapital(_name_16);
