...
public class Category {
  ...
  private CharSequence categoryBaseImpl(final Application it) {
    ...
    _builder.newLine();
    _builder.append(" ");
    _builder.append("* Builds a list of where clauses for a given list of categories.");
    _builder.newLine();
    _builder.append(" ");
    _builder.append("*");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append(" ");
    _builder.append("* @return array List of where clauses per registry / property.");
    _builder.newLine();
    _builder.append(" ");
    _builder.append("*/");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("        ");
    _builder.append("$result[] = \'(tblCategories.category IN (\' . DataUtil::formatForStore(implode(\', \', $catIds[$propertyName])) . \') AND tblCategories.categoryRegistryId = \' . $propertyId . \')\';");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("}");
    _builder.newLine();
