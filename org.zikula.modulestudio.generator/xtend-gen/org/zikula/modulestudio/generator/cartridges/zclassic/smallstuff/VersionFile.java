...
public class VersionFile {
  ...
  private CharSequence appInfoBaseImpl(final Application it) {
      ...
      if (_not_2) {
        ...
        _builder.append("    ");
        {
          ...
          for(final ReferredApplication referredApp : _referredApplications_2) {
            ...
            CharSequence _appDependency = this.appDependency(referredApp);
    ...
    final String appName = this._formattingExtensions.formatForDB(_name);
    _builder.newLineIfNotEmpty();
    {
  ...
  private CharSequence appInfoImpl(final Application it) {
    ...
    _builder.newLine();
    {
      ...
      if (_targets_1) {
        ...
        String _appName_3 = this._utils.appName(it);
        _builder.append(_appName_3, "");
        _builder.append("Version extends Base\\");
        String _appName_4 = this._utils.appName(it);
        _builder.append(_appName_4, "");
  ...
  private CharSequence appDependency(final ReferredApplication it) {
    StringConcatenation _builder = new StringConcatenation();
