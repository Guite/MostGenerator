...
public class ArrayVariableReference extends VariableReference {
    ...
    public ArrayVariableReference(DLTKToken token, Expression index,
            int arrayType) {
        super(token);
        this.index = index;
    ...
    public ArrayVariableReference(int start, int end, String name,
            VariableKind kind, Expression index, int arrayType) {
