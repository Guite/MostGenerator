...
// Mon Jul 26 11:48:25 CEST 2010
// ----------------------------------------------------

package org.zikula.modulestudio.generator.beautifier.pdt.internal.core.ast.scanner.php53;
 ...
 * 
 * @version Mon Jul 26 11:48:25 CEST 2010
 */
public class PhpAstParser extends java_cup.runtime.lr_parser {
    ...
    /** Production table. */
    protected static final short _production_table[][] = unpackFromStrings(new String[] { "\000\u0191\000\002\003\003\000\002\002\004\000\002\004"
    ...
    /** Parse-action table. */
    protected static final short[][] _action_table = unpackFromStrings(new String[] { "\000\u0335\000\002\001\ufffb\000\004\002\u0337\001\002\000"
    ...
    protected static final short[][] _reduce_table = unpackFromStrings(new String[] { "\000\u0335\000\006\003\003\007\004\001\001\000\002\001"
    ...
    public java_cup.runtime.Symbol do_action(int act_num,
        ...
        return action_obj.CUP$PhpAstParser$do_action(act_num, parser, stack,
                top);
    }
    ...
    protected final static Integer PROTECTED = new Integer(
    ...
    public Dispatch createDispatch(VariableBase dispatcher,
            VariableBase property) {
        Dispatch dispatch = null;
        if (property instanceof Variable) {
            dispatch = new FieldAccess(dispatcher.getStart(),
                    property.getEnd(), ast, dispatcher, (Variable) property);
        }
        else if (property instanceof FunctionInvocation) {
            dispatch = new MethodInvocation(dispatcher.getStart(),
                    property.getEnd(), ast, dispatcher,
     ...
     * subclasses). The super class prints the message to System.err.
     * 
     * @param message
     *            an error message.
     * @param info
...
class CUP$PhpAstParser$actions {
    ...
    public final java_cup.runtime.Symbol CUP$PhpAstParser$do_action(
            ...
            java.util.Stack CUP$PhpAstParser$stack, int CUP$PhpAstParser$top)
            throws java.lang.Exception {
        if (CUP$PhpAstParser$act_num < 100) {
            return CUP$PhpAstParser$do_action1(CUP$PhpAstParser$act_num,
                    CUP$PhpAstParser$parser, CUP$PhpAstParser$stack,
                    CUP$PhpAstParser$top);
        }
        else if (CUP$PhpAstParser$act_num < 200) {
            return CUP$PhpAstParser$do_action2(CUP$PhpAstParser$act_num,
                    CUP$PhpAstParser$parser, CUP$PhpAstParser$stack,
                    CUP$PhpAstParser$top);
        }
        else if (CUP$PhpAstParser$act_num < 300) {
            return CUP$PhpAstParser$do_action3(CUP$PhpAstParser$act_num,
                    CUP$PhpAstParser$parser, CUP$PhpAstParser$stack,
                    CUP$PhpAstParser$top);
        }
        else if (CUP$PhpAstParser$act_num < 400) {
            return CUP$PhpAstParser$do_action4(CUP$PhpAstParser$act_num,
                    CUP$PhpAstParser$parser, CUP$PhpAstParser$stack,
                    CUP$PhpAstParser$top);
        }
        else {
            return CUP$PhpAstParser$do_action5(CUP$PhpAstParser$act_num,
                    CUP$PhpAstParser$parser, CUP$PhpAstParser$stack,
                    CUP$PhpAstParser$top);
        }
    }
    ...
    public final java_cup.runtime.Symbol CUP$PhpAstParser$do_action1(
        ...
        switch (CUP$PhpAstParser$act_num) {
            ...
            {
                Program RESULT = null;
                final int sListleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).left;
                final int sListright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).right;
                final List sList = (List) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                ...
                RESULT = new Program(sListleft, sListright, parser.ast, sList,
                        commentList);
            ...
            {
                Object RESULT = null;
                final int start_valleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 1)).left;
                final int start_valright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 1)).right;
                final Program start_val = (Program) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
            ...
            {
                List RESULT = null;
                final int nleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).left;
                final int nright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).right;
                final String n = (String) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).value;
            ...
            {
                List RESULT = null;
                final int listleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 2)).left;
                final int listright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 2)).right;
                final List list = (List) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
            ...
            case 5: // top_statement_list ::= top_statement_list top_statement
            {
                ...
                final int statementright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).right;
                final Statement statement = (Statement) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).value;

                if (statement != null) {
                    if (!(statement instanceof NamespaceDeclaration)
                            && sList.size() > 0) {
                        final Statement lastStatement = (Statement) ((LinkedList) sList)
                                .getLast();
                        if (!(statement instanceof EmptyStatement)
                                && lastStatement instanceof NamespaceDeclaration
                                && !((NamespaceDeclaration) lastStatement)
                                        .isBracketed()) {
                            ((NamespaceDeclaration) lastStatement)
            ...
            case 8: // top_statement ::= function_declaration_statement
            {
                ...
                final int statementright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).right;
                final FunctionDeclaration statement = (FunctionDeclaration) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).value;
                     ...
                     // T_CLOSE_PARENTHESE T_SEMICOLON
            {
                ...
                final int statementright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).right;
                final Object statement = (Object) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).value;
            ...
            {
                Statement RESULT = null;
                final int sleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 2)).left;
                final int sright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 2)).right;
                final Object s = (Object) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 2)).value;
                final int listleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 1)).left;
                final int listright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                ...
                final List list = (List) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 1)).value;
                final int eleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).left;
                final int eright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).right;
                final Object e = (Object) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).value;

                RESULT = new NamespaceDeclaration(sleft, eright, parser.ast,
                        new NamespaceName(listleft, listright, parser.ast,
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 12: // top_statement ::= T_NAMESPACE namespace_name
                     // T_CURLY_OPEN top_statement_list T_CURLY_CLOSE
            {
                Statement RESULT = null;
                final int sleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 4)).left;
                final int sright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                ...
                final int tokenleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 2)).left;
                final int tokenright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 2)).right;
                final Object token = (Object) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 2)).value;
                final int sListleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 1)).left;
                final int sListright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                ...
                RESULT = new NamespaceDeclaration(sleft, eright, parser.ast,
                        new NamespaceName(listleft, listright, parser.ast,
                                list, false, false), new Block(tokenleft,
                                eright, parser.ast, sList), true);
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 13: // top_statement ::= T_NAMESPACE T_CURLY_OPEN
                     // top_statement_list T_CURLY_CLOSE
            {
                Statement RESULT = null;
                final int sleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 3)).left;
                ...
                RESULT = new NamespaceDeclaration(sleft, eright, parser.ast,
                        null, new Block(tokenleft, eright, parser.ast, sList),
                        true);
            ...
            case 15: // top_statement ::= constant_declaration T_SEMICOLON
            {
                ...
                RESULT = new ConstantDeclaration(listleft, eright, parser.ast,
                        list);
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 16: // use_declarations ::= use_declarations T_COMMA
                     // use_declaration
            {
                List RESULT = null;
                final int listleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                ...
                final List list = (List) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 2)).value;
                final int useDeclleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).left;
                final int useDeclright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).right;
                final UseStatementPart useDecl = (UseStatementPart) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).value;
            ...
            case 19: // use_declaration ::= namespace_name T_AS T_STRING
            {
                ...
                final List list = (List) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 2)).value;
                final int aliasNameleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).left;
                final int aliasNameright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).right;
                final String aliasName = (String) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).value;

                RESULT = new UseStatementPart(listleft, aliasNameright,
                        parser.ast, new NamespaceName(listleft, listright,
                                parser.ast, list, false, false),
                        new Identifier(aliasNameleft, aliasNameright,
                                parser.ast, aliasName));
            ...
            case 20: // use_declaration ::= T_NS_SEPARATOR namespace_name
            {
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 21: // use_declaration ::= T_NS_SEPARATOR namespace_name T_AS
                     // T_STRING
            {
                UseStatementPart RESULT = null;
                final int listleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                ...
                RESULT = new UseStatementPart(listleft, aliasNameright,
                        parser.ast, new NamespaceName(listleft, listright,
                                parser.ast, list, true, false), new Identifier(
                                aliasNameleft, aliasNameright, parser.ast,
                                aliasName));
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 22: // inner_statement_list ::= inner_statement_list
                     // inner_statement
            {
                List RESULT = null;
                final int sListleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                     ...
                     // T_CLOSE_PARENTHESE T_SEMICOLON
            {
                ...
                final int haltright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 3)).right;
                final Object halt = (Object) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 3)).value;
                final int closeleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 1)).left;
                final int closeright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 1)).right;
                final Object close = (Object) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 1)).value;
            ...
            {
                Statement RESULT = null;
                final int labelleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 1)).left;
                final int labelright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 1)).right;
                final String label = (String) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 1)).value;
                final int eleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).left;
                final int eright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                ...
                RESULT = new GotoLabel(
                        labelleft,
                        eright,
                        parser.ast,
                        new Identifier(labelleft, labelright, parser.ast, label));
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 30: // unticked_statement ::= T_CURLY_OPEN inner_statement_list
                     // T_CURLY_CLOSE
            {
                Statement RESULT = null;
                final int tokenleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 31: // unticked_statement ::= T_IF T_OPEN_PARENTHESE expr
                     // T_CLOSE_PARENTHESE statement elseif_list else_single
            {
                Statement RESULT = null;
                final int tokenleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 6)).left;
                final int tokenright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 6)).right;
                final Object token = (Object) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 6)).value;
                final int condleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 4)).left;
                final int condright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 4)).right;
                final Expression cond = (Expression) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 4)).value;
                final int iftrueleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 2)).left;
                final int iftrueright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 2)).right;
                final Statement iftrue = (Statement) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 2)).value;
                final int elseifleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 1)).left;
                final int elseifright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 1)).right;
                final List[] elseif = (List[]) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 1)).value;
                final int iffalseleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).left;
                final int iffalseright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).right;
                final Statement iffalse = (Statement) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).value;
                ...
                for (int i = 0; i < elseif[0].size(); i++) {
                    ...
                    final int s = ((Integer) elseif[2].get(i)).intValue();
                    falseStatement = new IfStatement(s, iffalseright,
                            parser.ast, innerCondition, trueStatement,
                            falseStatement);
                }
                RESULT = new IfStatement(tokenleft, iffalseright, parser.ast,
                        cond, iftrue, falseStatement);
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 32: // unticked_statement ::= T_IF T_OPEN_PARENTHESE expr
                     // T_CLOSE_PARENTHESE T_NEKUDOTAIM inner_statement_list
                     // new_elseif_list new_else_single T_ENDIF T_SEMICOLON
            {
                Statement RESULT = null;
                final int tokenleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 9)).left;
                final int tokenright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 9)).right;
                final Object token = (Object) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 9)).value;
                final int condleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 7)).left;
                final int condright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 7)).right;
                final Expression cond = (Expression) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 7)).value;
                final int colonleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 5)).left;
                final int colonright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 5)).right;
                final Object colon = (Object) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 5)).value;
                final int ifTrueStatementListleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 4)).left;
                final int ifTrueStatementListright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 4)).right;
                final List ifTrueStatementList = (List) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 4)).value;
                final int elseifleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 3)).left;
                final int elseifright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                ...
                final Block block = new Block(colonleft,
                        ifTrueStatementListright, parser.ast,
                        ifTrueStatementList, false);
                RESULT = new IfStatement(tokenleft, eright, parser.ast, cond,
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 33: // unticked_statement ::= T_WHILE T_OPEN_PARENTHESE expr
                     // T_CLOSE_PARENTHESE while_statement
            {
                ...
                final Object token = (Object) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 4)).value;
                final int exprleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 2)).left;
                final int exprright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 2)).right;
                final Expression expr = (Expression) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 2)).value;
                final int statementleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).left;
                final int statementright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                ...
                RESULT = new WhileStatement(tokenleft, statementright,
                        parser.ast, expr, statement);
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 34: // unticked_statement ::= T_DO statement T_WHILE
                     // T_OPEN_PARENTHESE expr T_CLOSE_PARENTHESE T_SEMICOLON
            {
                ...
                RESULT = new DoStatement(tokenleft, eright, parser.ast, expr,
                        statement);
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 35: // unticked_statement ::= T_FOR T_OPEN_PARENTHESE for_expr
                     // T_SEMICOLON for_expr T_SEMICOLON for_expr
                     // T_CLOSE_PARENTHESE for_statement
            {
                Statement RESULT = null;
                final int tokenleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 8)).left;
                final int tokenright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 8)).right;
                final Object token = (Object) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 8)).value;
                final int initializationsleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 6)).left;
                final int initializationsright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 6)).right;
                final List initializations = (List) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 6)).value;
                final int condsleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 4)).left;
                final int condsright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 4)).right;
                final List conds = (List) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 4)).value;
                final int increasementsleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 2)).left;
                final int increasementsright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 2)).right;
                final List increasements = (List) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 2)).value;
                final int statementleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).left;
                final int statementright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                ...
                RESULT = new ForStatement(tokenleft, statementright,
                        parser.ast, initializations, conds, increasements,
                        statement);
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 36: // unticked_statement ::= T_SWITCH T_OPEN_PARENTHESE expr
                     // T_CLOSE_PARENTHESE switch_case_list
            {
                ...
                final Expression expr = (Expression) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 2)).value;
                final int caseBlockleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).left;
                final int caseBlockright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).right;
                final Block caseBlock = (Block) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).value;

                RESULT = new SwitchStatement(tokenleft, caseBlockright,
                        parser.ast, expr, caseBlock);
            ...
            case 41: // unticked_statement ::= T_RETURN T_SEMICOLON
            {
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 42: // unticked_statement ::= T_RETURN expr_without_variable
                     // T_SEMICOLON
            {
                Statement RESULT = null;
                final int tokenleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
            ...
            case 43: // unticked_statement ::= T_RETURN variable T_SEMICOLON
            {
                ...
                final int exprright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 1)).right;
                final VariableBase expr = (VariableBase) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 1)).value;
                final int eleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).left;
                final int eright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 44: // unticked_statement ::= T_GLOBAL global_var_list
                     // T_SEMICOLON
            {
                Statement RESULT = null;
                final int sleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 45: // unticked_statement ::= T_STATIC static_var_list
                     // T_SEMICOLON
            {
                Statement RESULT = null;
                final int sleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
            ...
            case 46: // unticked_statement ::= T_ECHO echo_expr_list T_SEMICOLON
            {
                ...
                final Object s = (Object) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 2)).value;
                final int exprListleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 1)).left;
                final int exprListright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 1)).right;
                final List exprList = (List) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 1)).value;
                final int eleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).left;
                final int eright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
            ...
            {
                Statement RESULT = null;
                final int htmlleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).left;
                final int htmlright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).right;
                final Object html = (Object) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).value;
            ...
            case 48: // unticked_statement ::= expr T_SEMICOLON
            {
                ...
                RESULT = new ExpressionStatement(exprleft, eright, parser.ast,
                        expr);
            ...
            case 49: // unticked_statement ::= T_USE use_filename T_SEMICOLON
            {
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 50: // unticked_statement ::= T_UNSET T_OPEN_PARENTHESE
                     // unset_variables T_CLOSE_PARENTHESE T_SEMICOLON
            {
                ...
                final int sright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 4)).right;
                final String s = (String) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 4)).value;
                final int listleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 2)).left;
                final int listright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                ...
                final List list = (List) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 2)).value;
                final int closeParleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 1)).left;
                final int closeParright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 1)).right;
                final Object closePar = (Object) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 1)).value;
                final int eleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).left;
                final int eright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                ...
                RESULT = new ExpressionStatement(sleft, eright, parser.ast,
                        new FunctionInvocation(sleft, closeParright,
                                parser.ast, new FunctionName(sleft, sright,
                                        parser.ast, new Identifier(sleft,
                                                sright, parser.ast, "unset")),
                                list));
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 51: // unticked_statement ::= T_FOREACH T_OPEN_PARENTHESE
                     ...
                     // T_CLOSE_PARENTHESE foreach_statement
            {
                ...
                final VariableBase expr = (VariableBase) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 5)).value;
                final int varleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 3)).left;
                final int varright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 3)).right;
                final Expression var = (Expression) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 3)).value;
                final int argleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 2)).left;
                final int argright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 2)).right;
                final Expression arg = (Expression) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 2)).value;
                final int statementleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).left;
                final int statementright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                ...
                if (arg == null) {
                    s = new ForEachStatement(tokenleft, statementright,
                            parser.ast, expr, var, statement);
                }
                else {
                    s = new ForEachStatement(tokenleft, statementright,
                            parser.ast, expr, var, arg, statement);
                }
                RESULT = s;
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 52: // unticked_statement ::= T_FOREACH T_OPEN_PARENTHESE
                     ...
                     // T_CLOSE_PARENTHESE foreach_statement
            {
                ...
                final int varright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 3)).right;
                final VariableBase var = (VariableBase) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 3)).value;
                final int argleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 2)).left;
                final int argright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 53: // unticked_statement ::= T_DECLARE T_OPEN_PARENTHESE
                     // declare_list T_CLOSE_PARENTHESE declare_statement
            {
                ...
                final Object s = (Object) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 4)).value;
                final int listsleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 2)).left;
                final int listsright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 2)).right;
                final List[] lists = (List[]) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 2)).value;
                final int statementleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).left;
                final int statementright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                ...
                RESULT = new DeclareStatement(sleft, statementright,
                        parser.ast, lists[0], lists[1], statement);
            ...
            case 54: // unticked_statement ::= T_SEMICOLON
            {
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 55: // unticked_statement ::= T_TRY T_CURLY_OPEN
                     ...
                     // inner_statement_list T_CURLY_CLOSE additional_catches
            {
                Statement RESULT = null;
                final int sleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 12)).left;
                final int sright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 12)).right;
                final Object s = (Object) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 12)).value;
                final int tryBlockStartleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 11)).left;
                final int tryBlockStartright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 11)).right;
                final Object tryBlockStart = (Object) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 11)).value;
                final int tryListleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 10)).left;
                final int tryListright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 10)).right;
                final List tryList = (List) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 10)).value;
                final int tryBlockEndleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 9)).left;
                final int tryBlockEndright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 9)).right;
                final Object tryBlockEnd = (Object) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 9)).value;
                final int catch_wordleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 8)).left;
                final int catch_wordright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 8)).right;
                final Object catch_word = (Object) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 8)).value;
                final int classNameleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 6)).left;
                final int classNameright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 6)).right;
                final NamespaceName className = (NamespaceName) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 6)).value;
                final int varleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 5)).left;
                final int varright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 5)).right;
                final Variable var = (Variable) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 5)).value;
                final int catchBlockStartleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 3)).left;
                final int catchBlockStartright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 3)).right;
                final Object catchBlockStart = (Object) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 3)).value;
                final int catchListleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 2)).left;
                final int catchListright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 2)).right;
                final List catchList = (List) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 2)).value;
                final int catchBlockEndleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 1)).left;
                final int catchBlockEndright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 1)).right;
                final Object catchBlockEnd = (Object) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 1)).value;
                final int catchesListleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).left;
                final int catchesListright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).right;
                final List catchesList = (List) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).value;

                final Block tryBlock = new Block(tryBlockStartleft,
                        tryBlockEndright, parser.ast, tryList);
                final Block catchBlock = new Block(catchBlockStartleft,
                        catchBlockEndright, parser.ast, catchList);
                final CatchClause catchClause = new CatchClause(catch_wordleft,
                        catchBlockEndright, parser.ast, className, var,
                        catchBlock);
                ((LinkedList) catchesList).addFirst(catchClause);
                RESULT = new TryStatement(sleft, catchesListright, parser.ast,
                        tryBlock, catchesList);
            ...
            {
                Statement RESULT = null;
                final int theErrorleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).left;
                final int theErrorright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).right;
                final Object theError = (Object) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).value;

                final ASTError error = new ASTError(theErrorleft,
                        theErrorright, parser.ast);
                RESULT = error;
            ...
            {
                Statement RESULT = null;
                final int varCommentleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 1)).left;
                final int varCommentright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 1)).right;
                final String varComment = (String) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 1)).value;
                final int statementleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).left;
                final int statementright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
            ...
            {
                List RESULT = null;
                final int catch_statementleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).left;
                final int catch_statementright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).right;
                final CatchClause catch_statement = (CatchClause) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).value;
                ...
                CUP$PhpAstParser$result = new java_cup.runtime.Symbol(
                        90/* non_empty_additional_catches */,
                        ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                                .elementAt(CUP$PhpAstParser$top - 0)).left,
                        ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                                .elementAt(CUP$PhpAstParser$top - 0)).right,
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 63: // non_empty_additional_catches ::=
                     // non_empty_additional_catches additional_catch
            {
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 64: // additional_catch ::= T_CATCH T_OPEN_PARENTHESE
                     ...
                     // T_CURLY_OPEN inner_statement_list T_CURLY_CLOSE
            {
                ...
                final int varright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 4)).right;
                final String var = (String) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 4)).value;
                final int catchBlockStartleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 2)).left;
                final int catchBlockStartright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                ...
                RESULT = new CatchClause(catch_wordleft, catchBlockEndright,
                        parser.ast, className, new Variable(varleft, varright,
                                parser.ast, var), new Block(
                                catchBlockStartleft, catchBlockEndright,
                                parser.ast, catchList));
            ...
            case 65: // unset_variables ::= unset_variable
            {
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 66: // unset_variables ::= unset_variables T_COMMA
                     // unset_variable
            {
                List RESULT = null;
                final int listleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
            ...
            case 68: // use_filename ::= T_CONSTANT_ENCAPSED_STRING
            {
                ...
                final int scalarleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).left;
                final int scalarright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).right;
                final String scalar = (String) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).value;

                RESULT = new Scalar(scalarleft, scalarright, parser.ast,
                        scalar, Scalar.TYPE_STRING);
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 69: // use_filename ::= T_OPEN_PARENTHESE
                     // T_CONSTANT_ENCAPSED_STRING T_CLOSE_PARENTHESE
            {
                ...
                RESULT = new Scalar(sleft, eright, parser.ast, scalar,
                        Scalar.TYPE_STRING);
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 70: // function_declaration_statement ::=
                     // unticked_function_declaration_statement
            {
                FunctionDeclaration RESULT = null;
                final int functionDeclarationleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).left;
                final int functionDeclarationright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).right;
                final FunctionDeclaration functionDeclaration = (FunctionDeclaration) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).value;
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 71: // class_declaration_statement ::=
                     // unticked_class_declaration_statement
            {
                Statement RESULT = null;
                final int classDeclarationleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).left;
                final int classDeclarationright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).right;
                final Statement classDeclaration = (Statement) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).value;
            ...
            case 73: // is_reference ::= T_REFERENCE
            {
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 74: // unticked_function_declaration_statement ::= T_FUNCTION
                     // is_reference string_st T_OPEN_PARENTHESE parameter_list
                     // T_CLOSE_PARENTHESE T_CURLY_OPEN inner_statement_list
                     // T_CURLY_CLOSE
            {
                FunctionDeclaration RESULT = null;
                final int sleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                ...
                final Object s = (Object) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 8)).value;
                final int isReferenceleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 7)).left;
                final int isReferenceright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 7)).right;
                final Boolean isReference = (Boolean) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 7)).value;
                final int fnleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 6)).left;
                final int fnright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 6)).right;
                final String fn = (String) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 6)).value;
                final int paramListleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 4)).left;
                final int paramListright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 4)).right;
                final List paramList = (List) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 4)).value;
                final int blockStartleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 2)).left;
                final int blockStartright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 2)).right;
                final Object blockStart = (Object) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 2)).value;
                final int sListleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 1)).left;
                final int sListright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                ...
                final List sList = (List) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 1)).value;
                final int blockEndleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).left;
                final int blockEndright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).right;
                final Object blockEnd = (Object) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).value;

                RESULT = new FunctionDeclaration(sleft, blockEndright,
                        parser.ast, new Identifier(fnleft, fnright, parser.ast,
                                fn), paramList, new Block(blockStartleft,
                                blockEndright, parser.ast, sList),
                        isReference.booleanValue());

                CUP$PhpAstParser$result = new java_cup.runtime.Symbol(
                        92/* unticked_function_declaration_statement */,
                        ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                                .elementAt(CUP$PhpAstParser$top - 8)).left,
                        ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                                .elementAt(CUP$PhpAstParser$top - 0)).right,
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 75: // unticked_class_declaration_statement ::=
                     // class_entry_type T_STRING extends_from implements_list
                     // T_CURLY_OPEN class_statement_list T_CURLY_CLOSE
            {
                Statement RESULT = null;
                final int modifierleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 6)).left;
                final int modifierright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 6)).right;
                final Integer modifier = (Integer) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 6)).value;
                final int classNameleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 5)).left;
                final int classNameright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 5)).right;
                final String className = (String) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 5)).value;
                final int superClassleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 4)).left;
                final int superClassright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 4)).right;
                final Expression superClass = (Expression) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 4)).value;
                final int interfacesleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 3)).left;
                final int interfacesright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 3)).right;
                final List interfaces = (List) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 3)).value;
                final int blockStartleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 2)).left;
                final int blockStartright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                ...
                RESULT = new ClassDeclaration(modifierleft, blockEndright,
                        parser.ast, modifier.intValue(), new Identifier(
                                classNameleft, classNameright, parser.ast,
                                className), superClass, interfaces, new Block(
                                blockStartleft, blockEndright, parser.ast,
                                sList));

                CUP$PhpAstParser$result = new java_cup.runtime.Symbol(
                        93/* unticked_class_declaration_statement */,
                        ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                                .elementAt(CUP$PhpAstParser$top - 6)).left,
                        ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                                .elementAt(CUP$PhpAstParser$top - 0)).right,
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 76: // unticked_class_declaration_statement ::= interface_entry
                     // T_STRING interface_extends_list T_CURLY_OPEN
                     // class_statement_list T_CURLY_CLOSE
            {
                Statement RESULT = null;
                final int sleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 5)).left;
                final int sright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 5)).right;
                final Integer s = (Integer) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 5)).value;
                final int classNameleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 4)).left;
                final int classNameright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                ...
                RESULT = new InterfaceDeclaration(sleft, blockEndright,
                        parser.ast, new Identifier(classNameleft,
                                classNameright, parser.ast, className),
                        interfaces, new Block(blockStartleft, blockEndright,
                                parser.ast, sList));
            ...
            case 87: // interface_list ::= fully_qualified_class_name
            {
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 88: // interface_list ::= interface_list T_COMMA
            ...
            case 93: // for_statement ::= statement
            {
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 94: // for_statement ::= T_NEKUDOTAIM inner_statement_list
                     // T_ENDFOR
            {
                Statement RESULT = null;
                final int startleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 2)).left;
                final int startright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 2)).right;
                final Object start = (Object) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 2)).value;
                final int statementListleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 1)).left;
                final int statementListright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 1)).right;
                final List statementList = (List) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 1)).value;
                final int endleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).left;
                final int endright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).right;
                final Object end = (Object) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).value;

                final Block block = new Block(startleft, endright, parser.ast,
                        statementList, false);
                RESULT = block;
            ...
            case 95: // foreach_statement ::= statement
            {
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 96: // foreach_statement ::= T_NEKUDOTAIM inner_statement_list
                     // T_ENDFOREACH
            {
                Statement RESULT = null;
                final int startleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
            ...
            case 97: // declare_statement ::= statement
            {
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 98: // declare_statement ::= T_NEKUDOTAIM inner_statement_list
                     // T_ENDDECLARE
            {
                Statement RESULT = null;
                final int startleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
            ...
            {
                List[] RESULT = null;
                final int keyleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 2)).left;
                final int keyright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 2)).right;
                final String key = (String) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 2)).value;
                final int valueleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).left;
                final int valueright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).right;
                final Expression value = (Expression) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).value;
    ...
    public final java_cup.runtime.Symbol CUP$PhpAstParser$do_action2(
        ...
        switch (CUP$PhpAstParser$act_num) {
            /* . . . . . . . . . . . . . . . . . . . . */
            case 100: // declare_list ::= declare_list T_COMMA string_st T_EQUAL
                      // static_scalar
            {
                List[] RESULT = null;
                final int listsleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 101: // switch_case_list ::= T_CURLY_OPEN case_list
                      // T_CURLY_CLOSE
            {
                Block RESULT = null;
                final int sleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                ...
                final Object s = (Object) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 2)).value;
                final int caseListleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 1)).left;
                final int caseListright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 1)).right;
                final List caseList = (List) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 1)).value;
                final int eleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).left;
                final int eright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 102: // switch_case_list ::= T_CURLY_OPEN T_SEMICOLON case_list
                      // T_CURLY_CLOSE
            {
                Block RESULT = null;
                final int sleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
            ...
            case 103: // switch_case_list ::= T_NEKUDOTAIM case_list T_ENDSWITCH
            {
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 104: // switch_case_list ::= T_NEKUDOTAIM T_SEMICOLON case_list
                      // T_ENDSWITCH
            {
                Block RESULT = null;
                final int startleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
            ...
            case 105: // case_list ::=
            {
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 106: // case_list ::= case_list T_CASE expr case_separator
                      // inner_statement_list
            {
                ...
                final int caseListright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 4)).right;
                List caseList = (List) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 4)).value;
                final int tokenleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 3)).left;
                final int tokenright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                ...
                final Expression expr = (Expression) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 2)).value;
                final int statementsleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).left;
                final int statementsright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).right;
                final List statements = (List) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).value;

                final SwitchCase switchCase = new SwitchCase(tokenleft,
                        statementsright, parser.ast, expr, statements, false);
                if (caseList == null) {
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 107: // case_list ::= case_list T_DEFAULT case_separator
                      // inner_statement_list
            {
                List RESULT = null;
                final int caseListleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                ...
                final SwitchCase switchCase = new SwitchCase(tokenleft,
                        statementsright, parser.ast, null, statements, true);
                if (caseList == null) {
                    caseList = new LinkedList(); // of SwitchCase
                }
                caseList.add(switchCase);
            ...
            case 110: // while_statement ::= statement
            {
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 111: // while_statement ::= T_NEKUDOTAIM inner_statement_list
                      // T_ENDWHILE
            {
                Statement RESULT = null;
                final int colonleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                ...
                final Block block = new Block(colonleft, endright, parser.ast,
                        statementList, false);
                RESULT = block;
            ...
            case 112: // elseif_list ::=
            {
                ...
                RESULT = new List[] { listConditions, listStatements,
                        listTokens };
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 113: // elseif_list ::= elseif_list T_ELSEIF T_OPEN_PARENTHESE
                      // expr T_CLOSE_PARENTHESE statement
            {
                List[] RESULT = null;
                final int elseifListleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 5)).left;
                final int elseifListright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 5)).right;
                final List[] elseifList = (List[]) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 5)).value;
                final int tokenleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 4)).left;
                final int tokenright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
            ...
            case 114: // new_elseif_list ::=
            {
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 115: // new_elseif_list ::= new_elseif_list T_ELSEIF
                      ...
                      // inner_statement_list
            {
                ...
                final Block block = new Block(colonleft, sListright,
                        parser.ast, sList, false);
                ((LinkedList) elseifList[0]).addFirst(cond);
            ...
            case 118: // new_else_single ::=
            {
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 119: // new_else_single ::= T_ELSE T_NEKUDOTAIM
                      // inner_statement_list
            {
                Statement RESULT = null;
                final int colonleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                ...
                RESULT = new Block(colonleft, listright, parser.ast, list,
                        false);
            ...
            {
                List RESULT = null;
                final int parameterleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).left;
                final int parameterright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).right;
                final FormalParameter parameter = (FormalParameter) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).value;
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 123: // non_empty_parameter_list ::= non_empty_parameter_list
                      // T_COMMA parameter
            {
                List RESULT = null;
                final int listleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
            ...
            case 124: // parameter ::= optional_class_type T_VARIABLE
            {
                ...
                final int classTypeleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 1)).left;
                final int classTyperight = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 1)).right;
                final Expression classType = (Expression) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 1)).value;
                final int varleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).left;
                final int varright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                ...
                final int s = classType == null ? varleft : classTypeleft;
                final Variable v = new Variable(varleft, varright, parser.ast,
                        var);
                RESULT = new FormalParameter(s, varright, parser.ast,
                        classType, v);
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 125: // parameter ::= optional_class_type T_REFERENCE
                      // T_VARIABLE
            {
                FormalParameter RESULT = null;
                final int classTypeleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                ...
                final Expression classType = (Expression) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 2)).value;
                final int refleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 1)).left;
                final int refright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 1)).right;
                final Object ref = (Object) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 1)).value;
                final int varleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).left;
                final int varright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                ...
                final int s = classType == null ? refleft : classTypeleft;
                final Variable v = new Variable(varleft, varright, parser.ast,
                        var);
                final Reference ref_var = new Reference(refleft, varright,
                        parser.ast, v);
                RESULT = new FormalParameter(s, varright, parser.ast,
                        classType, ref_var);
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 126: // parameter ::= optional_class_type T_VARIABLE T_EQUAL
                      // static_scalar
            {
                FormalParameter RESULT = null;
                final int classTypeleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                ...
                final int scalarright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).right;
                final Expression scalar = (Expression) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).value;

                final int s = classType == null ? varleft : classTypeleft;
                final Variable v = new Variable(varleft, varright, parser.ast,
                        var);
                RESULT = new FormalParameter(s, scalarright, parser.ast,
                        classType, v, scalar);
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 127: // parameter ::= optional_class_type T_REFERENCE
            ...
            {
                Expression RESULT = null;
                final int arrayleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).left;
                final int arrayright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).right;
                final Object array = (Object) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).value;

                RESULT = new Identifier(arrayleft, arrayright, parser.ast,
                        "array");
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 131: // function_call_parameter_list ::=
                      // non_empty_function_call_parameter_list
            {
                List RESULT = null;
                final int paramsListleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).left;
                final int paramsListright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).right;
                final List paramsList = (List) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).value;

                RESULT = paramsList;

                CUP$PhpAstParser$result = new java_cup.runtime.Symbol(
                        33/* function_call_parameter_list */,
                        ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                                .elementAt(CUP$PhpAstParser$top - 0)).left,
                        ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                                .elementAt(CUP$PhpAstParser$top - 0)).right,
            ...
            case 132: // function_call_parameter_list ::=
            {
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 133: // non_empty_function_call_parameter_list ::=
                      // expr_without_variable
            {
                ...
                CUP$PhpAstParser$result = new java_cup.runtime.Symbol(
                        34/* non_empty_function_call_parameter_list */,
                        ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                                .elementAt(CUP$PhpAstParser$top - 0)).left,
                        ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                                .elementAt(CUP$PhpAstParser$top - 0)).right,
            ...
            case 134: // non_empty_function_call_parameter_list ::= variable
            {
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 135: // non_empty_function_call_parameter_list ::= T_REFERENCE
                      // w_variable
            {
                List RESULT = null;
                final int sleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                ...
                final List paramsList = new LinkedList();
                final Expression var_ref = new Reference(sleft, varright,
                        parser.ast, var);
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 136: // non_empty_function_call_parameter_list ::=
                      ...
                      // expr_without_variable
            {
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 137: // non_empty_function_call_parameter_list ::=
                      // non_empty_function_call_parameter_list T_COMMA variable
            {
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 138: // non_empty_function_call_parameter_list ::=
                      // non_empty_function_call_parameter_list T_COMMA
            ...
            case 142: // global_var ::= T_DOLLAR r_variable
            {
                ...
                RESULT = new ReflectionVariable(sleft, varright, parser.ast,
                        var);
            ...
            case 143: // global_var ::= T_DOLLAR T_CURLY_OPEN expr T_CURLY_CLOSE
            {
                ...
                final Object s = (Object) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 3)).value;
                final int varNameleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 1)).left;
                final int varNameright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 1)).right;
                final Expression varName = (Expression) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 1)).value;
                final int eleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).left;
                final int eright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                ...
                RESULT = new ReflectionVariable(sleft, eright, parser.ast,
                        varName);
                      ...
                      // T_EQUAL static_scalar
            {
                ...
                final Assignment assignment = new Assignment(varleft,
                        exprright, parser.ast, v, Assignment.OP_EQUAL, expr);
                list.add(assignment);
                RESULT = list;
            ...
            case 147: // static_var_list ::= T_VARIABLE T_EQUAL static_scalar
            {
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 148: // class_statement_list ::= class_statement_list
                      // class_statement
            {
                List RESULT = null;
                final int listleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                ...
                final List list = (List) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 1)).value;
                final int classStatementleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).left;
                final int classStatementright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).right;
                final Statement classStatement = (Statement) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).value;
            ...
            case 149: // class_statement_list ::=
            {
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 150: // class_statement ::= variable_modifiers
                      // class_variable_declaration T_SEMICOLON
            {
                ...
                final Integer modifier = (Integer) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 2)).value;
                final int decListleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 1)).left;
                final int decListright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 1)).right;
                final List decList = (List) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 1)).value;
                final int eleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).left;
                final int eright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                ...
                RESULT = new FieldsDeclaration(modifierleft, eright,
                        parser.ast, modifier.intValue(), decList);
            ...
            case 151: // class_statement ::= constant_declaration T_SEMICOLON
            {
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 152: // class_statement ::= method_modifiers T_FUNCTION
                      // is_reference string_st T_OPEN_PARENTHESE parameter_list
                      // T_CLOSE_PARENTHESE method_body
            {
                Statement RESULT = null;
                final int modifierleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 7)).left;
                final int modifierright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 7)).right;
                Integer modifier = (Integer) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 7)).value;
                final int sleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 6)).left;
                final int sright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                ...
                final List paramList = (List) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 2)).value;
                final int bodyleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).left;
                final int bodyright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).right;
                final Block body = (Block) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).value;

                final int methodStart = modifier == null ? sleft : modifierleft;
                modifier = modifier == null ? PhpAstParser.PUBLIC : modifier;
                final Identifier functionId = new Identifier(fnleft, fnright,
                        parser.ast, fn);
                final FunctionDeclaration functionDeclaration = new FunctionDeclaration(
                        sleft, bodyright, parser.ast, functionId, paramList,
                        body, isReference.booleanValue());
                RESULT = new MethodDeclaration(methodStart, bodyright,
                        parser.ast, modifier.intValue(), functionDeclaration,
                        true);
            ...
            case 154: // method_body ::= T_SEMICOLON
            {
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 155: // method_body ::= T_CURLY_OPEN inner_statement_list
                      // T_CURLY_CLOSE
            {
                Block RESULT = null;
                final int sleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                ...
                final Block block = new Block(sleft, eright, parser.ast, list);
                RESULT = block;
            ...
            case 156: // variable_modifiers ::= non_empty_member_modifiers
            {
                ...
                for (final Iterator it = list.iterator(); it.hasNext();) {
                    final Integer modifier = (Integer) it.next();
                    result |= modifier.intValue();
                }
                RESULT = new Integer(result);

                CUP$PhpAstParser$result = new java_cup.runtime.Symbol(
                        100/* variable_modifiers */,
                        ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                                .elementAt(CUP$PhpAstParser$top - 0)).left,
                        ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                                .elementAt(CUP$PhpAstParser$top - 0)).right,
            ...
            case 160: // non_empty_member_modifiers ::= member_modifier
            {
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 161: // non_empty_member_modifiers ::=
            ...
            case 167: // member_modifier ::= T_FINAL
            {
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 168: // class_variable_declaration ::=
                      // class_variable_declaration T_COMMA T_VARIABLE
            {
                ...
                final Variable varId = new Variable(varleft, varright,
                        parser.ast, var);
                list.add(new ASTNode[] { varId, null });
                RESULT = list;

                CUP$PhpAstParser$result = new java_cup.runtime.Symbol(
                        78/* class_variable_declaration */,
                        ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                                .elementAt(CUP$PhpAstParser$top - 2)).left,
                        ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                                .elementAt(CUP$PhpAstParser$top - 0)).right,
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 169: // class_variable_declaration ::=
            ...
            case 170: // class_variable_declaration ::= T_VARIABLE
            {
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 171: // class_variable_declaration ::= T_VARIABLE T_EQUAL
                      // static_scalar
            {
                List RESULT = null;
                final int varleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 172: // constant_declaration ::= constant_declaration T_COMMA
                      // T_STRING T_EQUAL static_scalar
            {
                ...
                final List list = (List) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 4)).value;
                final int constNameleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 2)).left;
                final int constNameright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 2)).right;
                final String constName = (String) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 2)).value;
                final int exprleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).left;
                final int exprright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                ...
                final Identifier constId = new Identifier(constNameleft,
                        constNameright, parser.ast, constName);
                list.add(new ASTNode[] { constId, expr });
                RESULT = list;

                CUP$PhpAstParser$result = new java_cup.runtime.Symbol(
                        79/* constant_declaration */,
                        ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                                .elementAt(CUP$PhpAstParser$top - 4)).left,
                        ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                                .elementAt(CUP$PhpAstParser$top - 0)).right,
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 173: // constant_declaration ::= T_CONST T_STRING T_EQUAL
                      // static_scalar
            {
                List RESULT = null;
                final int constNameleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
            ...
            case 179: // non_empty_for_expr ::= expr
            {
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 180: // expr_without_variable ::= T_LIST T_OPEN_PARENTHESE
                      // assignment_list T_CLOSE_PARENTHESE T_EQUAL expr
            {
                ...
                final Object s = (Object) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 5)).value;
                final int varListleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 3)).left;
                final int varListright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 3)).right;
                final List varList = (List) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 3)).value;
                final int closeleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 2)).left;
                final int closeright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                ...
                final ListVariable vars = new ListVariable(sleft, closeright,
                        parser.ast, varList);
                RESULT = new Assignment(sleft, exprright, parser.ast, vars,
                        Assignment.OP_EQUAL, expr);

                CUP$PhpAstParser$result = new java_cup.runtime.Symbol(
                        44/* expr_without_variable */,
                        ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                                .elementAt(CUP$PhpAstParser$top - 5)).left,
                        ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                                .elementAt(CUP$PhpAstParser$top - 0)).right,
            ...
            case 181: // expr_without_variable ::= variable T_EQUAL expr
            {
                ...
                RESULT = new Assignment(varleft, exprright, parser.ast, var,
                        Assignment.OP_EQUAL, expr);
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 182: // expr_without_variable ::= variable T_EQUAL T_REFERENCE
                      // variable
            {
                Expression RESULT = null;
                final int varleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                ...
                final VariableBase var = (VariableBase) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 3)).value;
                final int reftokenleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 1)).left;
                final int reftokenright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 1)).right;
                final Object reftoken = (Object) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 1)).value;
                final int refvarleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).left;
                final int refvarright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).right;
                final VariableBase refvar = (VariableBase) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).value;

                RESULT = new Assignment(varleft, refvarright, parser.ast, var,
                        Assignment.OP_EQUAL, new Reference(reftokenleft,
                                refvarright, parser.ast, refvar));
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 183: // expr_without_variable ::= variable T_EQUAL T_REFERENCE
                      // T_NEW class_name_reference ctor_arguments
            {
                ...
                final int classNameright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 1)).right;
                final ClassName className = (ClassName) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 1)).value;
                final int ctorleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).left;
                final int ctorright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).right;
                final List ctor = (List) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).value;

                RESULT = new Assignment(varleft, ctorright, parser.ast, var,
                        Assignment.OP_EQUAL, new Reference(reftokenleft,
                                ctorright, parser.ast,
                                new ClassInstanceCreation(sleft, ctorright,
                                        parser.ast, className, ctor)));
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 184: // expr_without_variable ::= T_NEW class_name_reference
                      // ctor_arguments
            {
                Expression RESULT = null;
                final int sleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                ...
                RESULT = new ClassInstanceCreation(sleft, ctorright,
                        parser.ast, className, ctor);
            ...
            case 197: // expr_without_variable ::= rw_variable T_INC
            {
                ...
                RESULT = new PostfixExpression(varleft, tokenright, parser.ast,
                        var, PostfixExpression.OP_INC);
            ...
            case 198: // expr_without_variable ::= T_INC rw_variable
            {
                ...
                RESULT = new PrefixExpression(tokenleft, varright, parser.ast,
                        var, PrefixExpression.OP_INC);
    ...
    public final java_cup.runtime.Symbol CUP$PhpAstParser$do_action3(
        ...
        switch (CUP$PhpAstParser$act_num) {
            ...
            {
                Expression RESULT = null;
                final int expr1left = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 2)).left;
                final int expr1right = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 2)).right;
                final Expression expr1 = (Expression) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 2)).value;
                final int expr2left = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).left;
                final int expr2right = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).right;
                final Expression expr2 = (Expression) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).value;

                RESULT = new InfixExpression(expr1left, expr2right, parser.ast,
                        expr1, InfixExpression.OP_BOOL_OR, expr2);
            ...
            case 202: // expr_without_variable ::= expr T_BOOLEAN_AND expr
            {
                ...
                RESULT = new InfixExpression(expr1left, expr2right, parser.ast,
                        expr1, InfixExpression.OP_BOOL_AND, expr2);
            ...
            case 203: // expr_without_variable ::= expr T_LOGICAL_OR expr
            {
                ...
                RESULT = new InfixExpression(expr1left, expr2right, parser.ast,
                        expr1, InfixExpression.OP_STRING_OR, expr2);
            ...
            case 204: // expr_without_variable ::= expr T_LOGICAL_AND expr
            {
                ...
                RESULT = new InfixExpression(expr1left, expr2right, parser.ast,
                        expr1, InfixExpression.OP_STRING_AND, expr2);
            ...
            case 205: // expr_without_variable ::= expr T_LOGICAL_XOR expr
            {
                ...
                RESULT = new InfixExpression(expr1left, expr2right, parser.ast,
                        expr1, InfixExpression.OP_STRING_XOR, expr2);
            ...
            case 206: // expr_without_variable ::= expr T_OR expr
            {
                ...
                RESULT = new InfixExpression(expr1left, expr2right, parser.ast,
                        expr1, InfixExpression.OP_OR, expr2);
            ...
            case 207: // expr_without_variable ::= expr T_REFERENCE expr
            {
                ...
                RESULT = new InfixExpression(expr1left, expr2right, parser.ast,
                        expr1, InfixExpression.OP_AND, expr2);
            ...
            case 208: // expr_without_variable ::= expr T_KOVA expr
            {
                ...
                RESULT = new InfixExpression(expr1left, expr2right, parser.ast,
                        expr1, InfixExpression.OP_XOR, expr2);
            ...
            case 209: // expr_without_variable ::= expr T_NEKUDA expr
            {
                ...
                RESULT = new InfixExpression(expr1left, expr2right, parser.ast,
                        expr1, InfixExpression.OP_CONCAT, expr2);
            ...
            case 210: // expr_without_variable ::= expr T_PLUS expr
            {
                ...
                RESULT = new InfixExpression(expr1left, expr2right, parser.ast,
                        expr1, InfixExpression.OP_PLUS, expr2);
            ...
            case 211: // expr_without_variable ::= expr T_MINUS expr
            {
                ...
                RESULT = new InfixExpression(expr1left, expr2right, parser.ast,
                        expr1, InfixExpression.OP_MINUS, expr2);
            ...
            case 212: // expr_without_variable ::= expr T_TIMES expr
            {
                ...
                RESULT = new InfixExpression(expr1left, expr2right, parser.ast,
                        expr1, InfixExpression.OP_MUL, expr2);
            ...
            case 213: // expr_without_variable ::= expr T_DIV expr
            {
                ...
                RESULT = new InfixExpression(expr1left, expr2right, parser.ast,
                        expr1, InfixExpression.OP_DIV, expr2);
            ...
            case 214: // expr_without_variable ::= expr T_PRECENT expr
            {
                ...
                RESULT = new InfixExpression(expr1left, expr2right, parser.ast,
                        expr1, InfixExpression.OP_MOD, expr2);
            ...
            case 215: // expr_without_variable ::= expr T_SL expr
            {
                ...
                RESULT = new InfixExpression(expr1left, expr2right, parser.ast,
                        expr1, InfixExpression.OP_SL, expr2);
            ...
            case 216: // expr_without_variable ::= expr T_SR expr
            {
                ...
                RESULT = new InfixExpression(expr1left, expr2right, parser.ast,
                        expr1, InfixExpression.OP_SR, expr2);
            ...
            case 217: // expr_without_variable ::= T_PLUS expr
            {
                ...
                RESULT = new UnaryOperation(tokenleft, exprright, parser.ast,
                        expr, UnaryOperation.OP_PLUS);
            ...
            case 221: // expr_without_variable ::= expr T_IS_IDENTICAL expr
            {
                ...
                RESULT = new InfixExpression(expr1left, expr2right, parser.ast,
                        expr1, InfixExpression.OP_IS_IDENTICAL, expr2);
            ...
            case 222: // expr_without_variable ::= expr T_IS_NOT_IDENTICAL expr
            {
                ...
                RESULT = new InfixExpression(expr1left, expr2right, parser.ast,
                        expr1, InfixExpression.OP_IS_NOT_IDENTICAL, expr2);
            ...
            case 223: // expr_without_variable ::= expr T_IS_EQUAL expr
            {
                ...
                RESULT = new InfixExpression(expr1left, expr2right, parser.ast,
                        expr1, InfixExpression.OP_IS_EQUAL, expr2);
            ...
            case 224: // expr_without_variable ::= expr T_IS_NOT_EQUAL expr
            {
                ...
                RESULT = new InfixExpression(expr1left, expr2right, parser.ast,
                        expr1, InfixExpression.OP_IS_NOT_EQUAL, expr2);
            ...
            case 225: // expr_without_variable ::= expr T_RGREATER expr
            {
                ...
                RESULT = new InfixExpression(expr1left, expr2right, parser.ast,
                        expr1, InfixExpression.OP_RGREATER, expr2);
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 226: // expr_without_variable ::= expr T_IS_SMALLER_OR_EQUAL
                      // expr
            {
                Expression RESULT = null;
                final int expr1left = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                ...
                RESULT = new InfixExpression(expr1left, expr2right, parser.ast,
                        expr1, InfixExpression.OP_IS_SMALLER_OR_EQUAL, expr2);
            ...
            case 227: // expr_without_variable ::= expr T_LGREATER expr
            {
                ...
                RESULT = new InfixExpression(expr1left, expr2right, parser.ast,
                        expr1, InfixExpression.OP_LGREATER, expr2);
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 228: // expr_without_variable ::= expr T_IS_GREATER_OR_EQUAL
                      // expr
            {
                Expression RESULT = null;
                final int expr1left = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                ...
                RESULT = new InfixExpression(expr1left, expr2right, parser.ast,
                        expr1, InfixExpression.OP_IS_GREATER_OR_EQUAL, expr2);
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 229: // expr_without_variable ::= expr T_INSTANCEOF
                      // class_name_reference
            {
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 230: // expr_without_variable ::= T_OPEN_PARENTHESE expr
                      // T_CLOSE_PARENTHESE
            {
                Expression RESULT = null;
                final int sleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                ...
                RESULT = new ParenthesisExpression(sleft, eright, parser.ast,
                        expr);
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 231: // expr_without_variable ::= expr T_QUESTION_MARK expr
                      // T_NEKUDOTAIM expr
            {
                Expression RESULT = null;
                final int condleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                ...
                final int ifTrueright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 2)).right;
                final Expression ifTrue = (Expression) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 2)).value;
                final int ifFalseleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).left;
                final int ifFalseright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).right;
                final Expression ifFalse = (Expression) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).value;

                RESULT = new ConditionalExpression(condleft, ifFalseright,
                        parser.ast, cond, ifTrue, ifFalse);
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 232: // expr_without_variable ::= expr T_QUESTION_MARK
                      // T_NEKUDOTAIM expr
            {
                Expression RESULT = null;
                final int condleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
            ...
            case 234: // expr_without_variable ::= T_INT_CAST expr
            {
                ...
                RESULT = new CastExpression(tokenleft, exprright, parser.ast,
                        expr, CastExpression.TYPE_INT);
            ...
            case 236: // expr_without_variable ::= T_STRING_CAST expr
            {
                ...
                RESULT = new CastExpression(tokenleft, exprright, parser.ast,
                        expr, CastExpression.TYPE_STRING);
            ...
            case 237: // expr_without_variable ::= T_ARRAY_CAST expr
            {
                ...
                RESULT = new CastExpression(tokenleft, exprright, parser.ast,
                        expr, CastExpression.TYPE_ARRAY);
            ...
            case 238: // expr_without_variable ::= T_OBJECT_CAST expr
            {
                ...
                RESULT = new CastExpression(tokenleft, exprright, parser.ast,
                        expr, CastExpression.TYPE_OBJECT);
            ...
            case 240: // expr_without_variable ::= T_UNSET_CAST expr
            {
                ...
                RESULT = new CastExpression(tokenleft, exprright, parser.ast,
                        expr, CastExpression.TYPE_UNSET);
            ...
            case 241: // expr_without_variable ::= T_EXIT exit_expr
            {
                ...
                final List expList = new LinkedList();
                if (expr != null) {
                    expList.add(expr);
                }
            ...
            case 243: // expr_without_variable ::= scalar
            {
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 244: // expr_without_variable ::= T_ARRAY T_OPEN_PARENTHESE
                      // array_pair_list T_CLOSE_PARENTHESE
            {
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 245: // expr_without_variable ::= T_BACKQUATE backticks_expr
                      // T_BACKQUATE
            {
                Expression RESULT = null;
                final int sleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
            ...
            case 246: // expr_without_variable ::= T_PRINT expr
            {
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 247: // expr_without_variable ::= T_FUNCTION is_reference
                      ...
                      // T_CURLY_CLOSE
            {
                ...
                final List paramList = (List) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 5)).value;
                final int varsListleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 3)).left;
                final int varsListright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 3)).right;
                final List varsList = (List) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 3)).value;
                final int blockStartleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 2)).left;
                final int blockStartright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                ...
                RESULT = new LambdaFunctionDeclaration(sleft, blockEndright,
                        parser.ast, paramList, varsList,
                        new Block(blockStartleft, blockEndright, parser.ast,
                                list), isReference.booleanValue());
            ...
            case 248: // lexical_vars ::=
            {
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 249: // lexical_vars ::= T_USE T_OPEN_PARENTHESE
                      // lexical_var_list T_CLOSE_PARENTHESE
            {
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 250: // lexical_var_list ::= lexical_var_list T_COMMA
                      // T_VARIABLE
            {
                List RESULT = null;
                final int listleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 251: // lexical_var_list ::= lexical_var_list T_COMMA
            ...
            case 253: // lexical_var_list ::= T_REFERENCE T_VARIABLE
            {
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 254: // function_call ::= namespace_name T_OPEN_PARENTHESE
                      // function_call_parameter_list T_CLOSE_PARENTHESE
            {
                ...
                final List list = (List) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 3)).value;
                final int parametersleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 1)).left;
                final int parametersright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 1)).right;
                final List parameters = (List) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 1)).value;
                final int eleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).left;
                final int eright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                ...
                RESULT = new FunctionInvocation(listleft, eright, parser.ast,
                        new FunctionName(listleft, listright, parser.ast,
                                new NamespaceName(listleft, listright,
                                        parser.ast, list, false, false)),
                        parameters);
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 255: // function_call ::= T_NAMESPACE T_NS_SEPARATOR
                      ...
                      // function_call_parameter_list T_CLOSE_PARENTHESE
            {
                ...
                RESULT = new FunctionInvocation(sleft, eright, parser.ast,
                        new FunctionName(sleft, listright, parser.ast,
                                new NamespaceName(sleft, listright, parser.ast,
                                        list, false, true)), parameters);
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 256: // function_call ::= T_NS_SEPARATOR namespace_name
                      ...
                      // T_CLOSE_PARENTHESE
            {
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 257: // function_call ::= class_name T_PAAMAYIM_NEKUDOTAYIM
                      ...
                      // T_CLOSE_PARENTHESE
            {
                ...
                final int classNameright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 5)).right;
                final Expression className = (Expression) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 5)).value;
                final int fnleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 3)).left;
                final int fnright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                ...
                RESULT = new StaticMethodInvocation(classNameleft, eright,
                        parser.ast, className, new FunctionInvocation(fnleft,
                                eright, parser.ast, new FunctionName(fnleft,
                                        fnright, parser.ast,
                                        new Identifier(fnleft, fnright,
                                                parser.ast, fn)), parameters));
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 258: // function_call ::= class_name T_PAAMAYIM_NEKUDOTAYIM
                      ...
                      // function_call_parameter_list T_CLOSE_PARENTHESE
            {
                ...
                final Expression className = (Expression) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 5)).value;
                final int reflectionNameleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 3)).left;
                final int reflectionNameright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 3)).right;
                final Variable reflectionName = (Variable) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 3)).value;
                final int parametersleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 1)).left;
                final int parametersright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                ...
                RESULT = new StaticMethodInvocation(classNameleft, eright,
                        parser.ast, className, new FunctionInvocation(
                                reflectionNameleft, eright, parser.ast,
                                new FunctionName(reflectionNameleft,
                                        reflectionNameright, parser.ast,
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 259: // function_call ::= variable_class_name
                      ...
                      // function_call_parameter_list T_CLOSE_PARENTHESE
            {
                ...
                final int classNameright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 5)).right;
                final Variable className = (Variable) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 5)).value;
                final int fnleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 3)).left;
                final int fnright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 260: // function_call ::= variable_class_name
                      ...
                      // T_CLOSE_PARENTHESE
            {
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 261: // function_call ::= variable_without_objects
                      // T_OPEN_PARENTHESE function_call_parameter_list
                      // T_CLOSE_PARENTHESE
            {
                VariableBase RESULT = null;
                ...
                RESULT = new FunctionInvocation(
                        reflectionNameleft,
                        eright,
                        parser.ast,
                        new FunctionName(reflectionNameleft,
                                reflectionNameright, parser.ast, reflectionName),
                        parameters);
            ...
            case 263: // class_name ::= namespace_name
            {
                ...
                RESULT = new NamespaceName(listleft, listright, parser.ast,
                        list, false, false);
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 264: // class_name ::= T_NAMESPACE T_NS_SEPARATOR
                      // namespace_name
            {
                Expression RESULT = null;
                final int listleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
            ...
            case 266: // fully_qualified_class_name ::= namespace_name
            {
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 267: // fully_qualified_class_name ::= T_NAMESPACE
                      // T_NS_SEPARATOR namespace_name
            {
                ...
                RESULT = new NamespaceName(sleft, listright, parser.ast, list,
                        false, true);
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 268: // fully_qualified_class_name ::= T_NS_SEPARATOR
                      // namespace_name
            {
                NamespaceName RESULT = null;
                final int sleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
            ...
            case 269: // class_name_reference ::= class_name
            {
                ...
                RESULT = new ClassName(classNameleft, classNameright,
                        parser.ast, className);

                CUP$PhpAstParser$result = new java_cup.runtime.Symbol(
                        107/* class_name_reference */,
                        ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                                .elementAt(CUP$PhpAstParser$top - 0)).left,
                        ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                                .elementAt(CUP$PhpAstParser$top - 0)).right,
            ...
            case 270: // class_name_reference ::= dynamic_class_name_reference
            {
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 271: // dynamic_class_name_reference ::= base_variable
                      ...
                      // dynamic_class_name_variable_properties
            {
                ...
                final VariableBase var = (VariableBase) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 3)).value;
                final int firstVarPropertyleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 1)).left;
                final int firstVarPropertyright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 1)).right;
                final VariableBase firstVarProperty = (VariableBase) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 1)).value;
                final int propertyListleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).left;
                final int propertyListright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).right;
                final List propertyList = (List) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).value;
                ...
                while (listIt.hasNext()) {
                    final VariableBase property = (VariableBase) listIt.next();
                    dispatch = parser.createDispatch(dispatcher, property);
                    dispatcher = dispatch;
                }

                // create class name from the dispatch
                RESULT = new ClassName(varleft, propertyListright, parser.ast,
                        dispatch);

                CUP$PhpAstParser$result = new java_cup.runtime.Symbol(
                        109/* dynamic_class_name_reference */,
                        ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                                .elementAt(CUP$PhpAstParser$top - 3)).left,
                        ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                                .elementAt(CUP$PhpAstParser$top - 0)).right,
            ...
            case 272: // dynamic_class_name_reference ::= base_variable
            {
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 273: // dynamic_class_name_variable_properties ::=
                      // dynamic_class_name_variable_properties
                      // dynamic_class_name_variable_property
            {
                List RESULT = null;
                final int variablesleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 1)).left;
                final int variablesright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 1)).right;
                final List variables = (List) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 1)).value;
                final int varleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).left;
                final int varright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                ...
                CUP$PhpAstParser$result = new java_cup.runtime.Symbol(
                        111/* dynamic_class_name_variable_properties */,
                        ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                                .elementAt(CUP$PhpAstParser$top - 1)).left,
                        ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                                .elementAt(CUP$PhpAstParser$top - 0)).right,
            ...
            case 274: // dynamic_class_name_variable_properties ::=
            {
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 275: // dynamic_class_name_variable_property ::=
                      // T_OBJECT_OPERATOR object_property
            {
                VariableBase RESULT = null;
                final int varleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                ...
                CUP$PhpAstParser$result = new java_cup.runtime.Symbol(
                        112/* dynamic_class_name_variable_property */,
                        ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                                .elementAt(CUP$PhpAstParser$top - 1)).left,
                        ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                                .elementAt(CUP$PhpAstParser$top - 0)).right,
            ...
            {
                List RESULT = null;
                final int stringleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).left;
                final int stringright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).right;
                final String string = (String) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).value;
            ...
            case 282: // ctor_arguments ::=
            {
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 283: // ctor_arguments ::= T_OPEN_PARENTHESE
                      // function_call_parameter_list T_CLOSE_PARENTHESE
            {
                List RESULT = null;
                final int paramsListleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
            ...
            case 287: // common_scalar ::= T_LINE
            {
                ...
                final int scalarright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).right;
                final Object scalar = (Object) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).value;
            ...
            case 293: // common_scalar ::= T_NS_C
            {
                ...
                RESULT = new Scalar(scalarleft, scalarright, parser.ast,
                        "__NAMESPACE__", Scalar.TYPE_SYSTEM);
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 294: // common_scalar ::= T_START_HEREDOC
                      // T_ENCAPSED_AND_WHITESPACE T_END_HEREDOC
            {
                ...
                final List list = new LinkedList();
                list.add(new Scalar(stringleft, stringright, parser.ast,
                        string, string == null ? Scalar.TYPE_UNKNOWN
                                : Scalar.TYPE_STRING));
                RESULT = new Quote(labelleft, eright, parser.ast, list,
            ...
            case 295: // common_scalar ::= T_START_HEREDOC T_END_HEREDOC
            {
                ...
                RESULT = new Quote(labelleft, eright, parser.ast,
                        new LinkedList(),
                        label.charAt(0) == '\'' ? Quote.QT_NOWDOC
                                : Quote.QT_HEREDOC);
            ...
            case 297: // static_scalar ::= namespace_name
            {
                ...
                if (list.size() == 1) {
                    RESULT = new Scalar(listleft, listright, parser.ast,
                            ((Identifier) list.get(0)).getName(),
                            Scalar.TYPE_STRING);
                }
                else {
                    RESULT = new NamespaceName(listleft, listright, parser.ast,
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 298: // static_scalar ::= T_NAMESPACE T_NS_SEPARATOR
                      // namespace_name
            {
                Expression RESULT = null;
                final int sleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
    ...
    public final java_cup.runtime.Symbol CUP$PhpAstParser$do_action4(
        ...
        switch (CUP$PhpAstParser$act_num) {
            ...
            case 300: // static_scalar ::= T_PLUS static_scalar
            {
                ...
                RESULT = new UnaryOperation(sleft, exprright, parser.ast, expr,
            ...
            case 301: // static_scalar ::= T_MINUS static_scalar
            {
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 302: // static_scalar ::= T_ARRAY T_OPEN_PARENTHESE
            ...
            {
                Expression RESULT = null;
                final int classConstantleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).left;
                final int classConstantright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).right;
                final StaticConstantAccess classConstant = (StaticConstantAccess) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).value;
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 304: // static_class_constant ::= class_name
                      // T_PAAMAYIM_NEKUDOTAYIM T_STRING
            {
                ...
                final int varNameright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).right;
                final String varName = (String) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).value;

                RESULT = new StaticConstantAccess(classNameleft, varNameright,
                        parser.ast, className, new Identifier(varNameleft,
                                varNameright, parser.ast, varName));

                CUP$PhpAstParser$result = new java_cup.runtime.Symbol(
                        113/* static_class_constant */,
                        ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                                .elementAt(CUP$PhpAstParser$top - 2)).left,
                        ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                                .elementAt(CUP$PhpAstParser$top - 0)).right,
            ...
            case 311: // scalar ::= T_QUATE encaps_list T_QUATE
            {
                ...
                RESULT = new Quote(sleft, eright, parser.ast, list,
                        Quote.QT_QUOTE);
            ...
            case 316: // possible_comma ::= T_COMMA
            {
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 317: // non_empty_static_array_pair_list ::=
                      ...
                      // T_DOUBLE_ARROW static_scalar
            {
                ...
                final int keyright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 2)).right;
                final Expression key = (Expression) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 2)).value;
                final int valueleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).left;
                final int valueright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                ...
                list.add(new ArrayElement(keyleft, valueright, parser.ast, key,
                        value));
                RESULT = list;

                CUP$PhpAstParser$result = new java_cup.runtime.Symbol(
                        53/* non_empty_static_array_pair_list */,
                        ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                                .elementAt(CUP$PhpAstParser$top - 4)).left,
                        ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                                .elementAt(CUP$PhpAstParser$top - 0)).right,
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 318: // non_empty_static_array_pair_list ::=
                      // non_empty_static_array_pair_list T_COMMA static_scalar
            {
                List RESULT = null;
                final int listleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                ...
                list.add(new ArrayElement(valueleft, valueright, parser.ast,
                        value));
                RESULT = list;
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 319: // non_empty_static_array_pair_list ::= static_scalar
                      // T_DOUBLE_ARROW static_scalar
            {
                List RESULT = null;
                final int keyleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
            ...
            {
                Expression RESULT = null;
                final int ewvleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).left;
                final int ewvright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).right;
                final Expression ewv = (Expression) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).value;
                RESULT = ewv;
                CUP$PhpAstParser$result = new java_cup.runtime.Symbol(
                        54/* expr */,
                      ...
                      // variable_properties
            {
                ...
                final VariableBase var = (VariableBase) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 4)).value;
                final int memberPropertyleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 2)).left;
                final int memberPropertyright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 2)).right;
                final VariableBase memberProperty = (VariableBase) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 2)).value;
                final int paramsListleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 1)).left;
                final int paramsListright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                ...
                if (paramsList == null) {
                    ...
                    final FunctionName fn = new FunctionName(
                            memberPropertyleft, memberPropertyright,
                            parser.ast, memberProperty);
                    firstVarProperty = new FunctionInvocation(
                            memberPropertyleft, paramsListright, parser.ast,
                            fn, paramsList);
                }
            ...
            case 327: // variable ::= base_variable_with_function_calls
            {
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 328: // variable_properties ::= variable_properties
                      // variable_property
            {
                List RESULT = null;
                final int variablesleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                ...
                final List variables = (List) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 1)).value;
                final int variablePropertyleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).left;
                final int variablePropertyright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).right;
                final VariableBase variableProperty = (VariableBase) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).value;
            ...
            case 329: // variable_properties ::=
            {
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 330: // variable_property ::= T_OBJECT_OPERATOR object_property
                      // method_or_not
            {
                VariableBase RESULT = null;
                final int memberPropertyleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                ...
                if (paramsList == null) {
                    ...
                    RESULT = new FunctionInvocation(memberPropertyleft,
                            paramsListright, parser.ast, new FunctionName(
                                    memberPropertyleft, memberPropertyright,
                                    parser.ast, memberProperty), paramsList);
                }

                CUP$PhpAstParser$result = new java_cup.runtime.Symbol(
                        103/* variable_property */,
                        ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                                .elementAt(CUP$PhpAstParser$top - 2)).left,
                        ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                                .elementAt(CUP$PhpAstParser$top - 0)).right,
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 331: // method_or_not ::= T_OPEN_PARENTHESE
                      // function_call_parameter_list T_CLOSE_PARENTHESE
            {
                List RESULT = null;
                final int paramsListleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
            ...
            case 333: // variable_without_objects ::= reference_variable
            {
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 334: // variable_without_objects ::= simple_indirect_reference
                      // reference_variable
            {
                Variable RESULT = null;
                final int ref_countleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 1)).left;
                final int ref_countright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 1)).right;
                final Integer ref_count = (Integer) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 1)).value;
                final int varleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).left;
                final int varright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                ...
                for (int i = 0; i < ref_count.intValue(); i++) {
                    finalVar = new ReflectionVariable(ref_countright - i - 1,
                            varright, parser.ast, finalVar);
                }
                RESULT = finalVar;
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 335: // static_member ::= class_name T_PAAMAYIM_NEKUDOTAYIM
                      // variable_without_objects
            {
                ...
                RESULT = new StaticFieldAccess(classNameleft, varright,
                        parser.ast, className, var);
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 336: // static_member ::= variable_class_name
                      // T_PAAMAYIM_NEKUDOTAYIM variable_without_objects
            {
                VariableBase RESULT = null;
                final int classNameleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
            ...
            case 338: // base_variable_with_function_calls ::= base_variable
            {
                ...
                RESULT = var;
                CUP$PhpAstParser$result = new java_cup.runtime.Symbol(
                        114/* base_variable_with_function_calls */,
                        ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                                .elementAt(CUP$PhpAstParser$top - 0)).left,
                        ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                                .elementAt(CUP$PhpAstParser$top - 0)).right,
            ...
            case 340: // base_variable ::= reference_variable
            {
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 341: // base_variable ::= simple_indirect_reference
                      // reference_variable
            {
                VariableBase RESULT = null;
                final int ref_countleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
            ...
            case 342: // base_variable ::= static_member
            {
                ...
                final int sright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).right;
                final VariableBase s = (VariableBase) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).value;
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 343: // reference_variable ::= reference_variable T_OPEN_RECT
                      // dim_offset T_CLOSE_RECT
            {
                ...
                final int varNameright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 3)).right;
                final Variable varName = (Variable) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 3)).value;
                final int indexleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 1)).left;
                final int indexright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 1)).right;
                final Expression index = (Expression) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 1)).value;
                final int eleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).left;
                final int eright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                ...
                RESULT = new ArrayAccess(varNameleft, eright, parser.ast,
                        varName, index, ArrayAccess.VARIABLE_ARRAY);

                CUP$PhpAstParser$result = new java_cup.runtime.Symbol(
                        55/* reference_variable */,
                        ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                                .elementAt(CUP$PhpAstParser$top - 3)).left,
                        ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                                .elementAt(CUP$PhpAstParser$top - 0)).right,
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 344: // reference_variable ::= reference_variable T_CURLY_OPEN
                      // expr T_CURLY_CLOSE
            {
                Variable RESULT = null;
                final int varNameleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                ...
                RESULT = new ArrayAccess(varNameleft, eright, parser.ast,
                        varName, index, ArrayAccess.VARIABLE_HASHTABLE);
            ...
            {
                Variable RESULT = null;
                final int comp_varleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).left;
                final int comp_varright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).right;
                final Variable comp_var = (Variable) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).value;
                RESULT = comp_var;
                CUP$PhpAstParser$result = new java_cup.runtime.Symbol(
                        55/* reference_variable */,
            ...
            case 346: // compound_variable ::= tracked_variable
            {
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 347: // compound_variable ::= T_DOLLAR T_CURLY_OPEN expr
                      // T_CURLY_CLOSE
            {
                Variable RESULT = null;
                final int sleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                ...
                final ReflectionVariable var = new ReflectionVariable(sleft,
                        eright, parser.ast, expr);
                RESULT = var;
            ...
            case 351: // object_property ::= variable_without_objects
            {
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 352: // object_dim_list ::= object_dim_list T_OPEN_RECT
                      // dim_offset T_CLOSE_RECT
            {
                VariableBase RESULT = null;
                final int varleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                ...
                RESULT = new ArrayAccess(varleft, eright, parser.ast, var,
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 353: // object_dim_list ::= object_dim_list T_CURLY_OPEN expr
                      // T_CURLY_CLOSE
            {
                VariableBase RESULT = null;
                final int varleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                ...
                RESULT = new ArrayAccess(varleft, eright, parser.ast, var,
                        index, ArrayAccess.VARIABLE_HASHTABLE);
            ...
            case 355: // variable_name ::= string_st
            {
                ...
                RESULT = new Variable(varNameleft, varNameright, parser.ast,
                        varName);
            ...
            case 357: // simple_indirect_reference ::= T_DOLLAR
            {
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 358: // simple_indirect_reference ::= simple_indirect_reference
                      // T_DOLLAR
            {
                Integer RESULT = null;
                final int refleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                ...
                final int refright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 1)).right;
                final Integer ref = (Integer) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 1)).value;
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 359: // assignment_list ::= assignment_list T_COMMA
                      // assignment_list_element
            {
                List RESULT = null;
                final int listElementsleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 2)).left;
                final int listElementsright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 2)).right;
                final List listElements = (List) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 2)).value;
                final int elementleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).left;
                final int elementright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).right;
                final VariableBase element = (VariableBase) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).value;
                ...
                if (element != null) {
                    ...
                    listElements.add(new Variable(elementleft, elementright,
                            parser.ast, ""));
                }
                RESULT = listElements;
            ...
            case 360: // assignment_list ::= assignment_list_element
            {
                ...
                if (var != null) {
                    ...
                    listElements.add(new Variable(varleft, varright,
                            parser.ast, ""));
                }
                RESULT = listElements;
            ...
            case 361: // assignment_list_element ::= variable
            {
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 362: // assignment_list_element ::= T_LIST T_OPEN_PARENTHESE
            ...
            case 364: // array_pair_list ::=
            {
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 365: // array_pair_list ::= non_empty_array_pair_list
                      // possible_comma
            {
                List RESULT = null;
                final int listleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 366: // non_empty_array_pair_list ::= non_empty_array_pair_list
                      // T_COMMA expr T_DOUBLE_ARROW expr
            {
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 367: // non_empty_array_pair_list ::= non_empty_array_pair_list
                      // T_COMMA expr
            {
                List RESULT = null;
                final int listleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
            ...
            case 369: // non_empty_array_pair_list ::= expr
            {
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 370: // non_empty_array_pair_list ::= non_empty_array_pair_list
                      // T_COMMA expr T_DOUBLE_ARROW T_REFERENCE w_variable
            {
                ...
                list.add(new ArrayElement(keyleft, varright, parser.ast, key,
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 371: // non_empty_array_pair_list ::= non_empty_array_pair_list
                      // T_COMMA T_REFERENCE w_variable
            {
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 372: // non_empty_array_pair_list ::= expr T_DOUBLE_ARROW
                      // T_REFERENCE w_variable
            {
                List RESULT = null;
                final int keyleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
            ...
            case 378: // encaps_var ::= tracked_variable
            {
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 379: // encaps_var ::= tracked_variable T_OPEN_RECT
                      // encaps_var_offset T_CLOSE_RECT
            {
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 380: // encaps_var ::= tracked_variable T_OBJECT_OPERATOR
                      // string_st
            {
                VariableBase RESULT = null;
                final int varleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                ...
                RESULT = parser.createDispatch(var, new Variable(stringleft,
                        stringright, parser.ast, string));
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 381: // encaps_var ::= T_DOLLAR_OPEN_CURLY_BRACES expr
                      // T_CURLY_CLOSE
            {
                VariableBase RESULT = null;
                final int sleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 382: // encaps_var ::= T_DOLLAR_OPEN_CURLY_BRACES
                      ...
                      // T_CURLY_CLOSE
            {
                ...
                RESULT = new ArrayAccess(sleft, eright, parser.ast,
                        new Variable(varNameleft, varNameright, parser.ast,
                                varName), index, ArrayAccess.VARIABLE_ARRAY);
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 383: // encaps_var ::= T_CURLY_OPEN_WITH_DOLAR variable
                      // T_CURLY_CLOSE
            {
                VariableBase RESULT = null;
                final int sleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
            ...
            case 384: // encaps_var_offset ::= string_st
            {
                ...
                RESULT = new Identifier(stringleft, stringright, parser.ast,
                        string);

                CUP$PhpAstParser$result = new java_cup.runtime.Symbol(
                        70/* encaps_var_offset */,
                        ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                                .elementAt(CUP$PhpAstParser$top - 0)).left,
                        ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                                .elementAt(CUP$PhpAstParser$top - 0)).right,
            ...
            {
                Expression RESULT = null;
                final int numleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).left;
                final int numright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).right;
                final String num = (String) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).value;

                RESULT = new Scalar(numleft, numright, parser.ast, num,
                        Scalar.TYPE_REAL);
            ...
            case 386: // encaps_var_offset ::= tracked_variable
            {
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 387: // internal_functions_in_yacc ::= T_ISSET
                      // T_OPEN_PARENTHESE isset_variables T_CLOSE_PARENTHESE
            {
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 388: // internal_functions_in_yacc ::= T_EMPTY
                      // T_OPEN_PARENTHESE variable T_CLOSE_PARENTHESE
            {
                ...
                final LinkedList varList = new LinkedList();
                varList.add(var);
                RESULT = new FunctionInvocation(sleft, eright, parser.ast,
                        new FunctionName(sleft, sright, parser.ast,
                                new Identifier(sleft, sright, parser.ast,
            ...
            {
                Expression RESULT = null;
                final int includeleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 1)).left;
                final int includeright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 1)).right;
                final String include = (String) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 1)).value;
                final int exprleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).left;
                final int exprright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                ...
                RESULT = new Include(includeleft, exprright, parser.ast, expr,
                        Include.IT_INCLUDE);
            ...
            case 390: // internal_functions_in_yacc ::= T_INCLUDE_ONCE expr
            {
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 391: // internal_functions_in_yacc ::= T_EVAL T_OPEN_PARENTHESE
                      // expr T_CLOSE_PARENTHESE
            {
                ...
                final LinkedList exprList = new LinkedList();
                exprList.add(expr);
                RESULT = new FunctionInvocation(sleft, eright, parser.ast,
                        new FunctionName(sleft, sright, parser.ast,
                                new Identifier(sleft, sright, parser.ast,
            ...
            case 395: // isset_variables ::= isset_variables T_COMMA variable
            {
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 396: // class_constant ::= class_name T_PAAMAYIM_NEKUDOTAYIM
                      // T_STRING
            {
                StaticConstantAccess RESULT = null;
                final int classNameleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
            case 397: // class_constant ::= variable_class_name
                      // T_PAAMAYIM_NEKUDOTAYIM T_STRING
            {
                StaticConstantAccess RESULT = null;
                final int classNameleft = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
            ...
            case 399: // string_st ::= T_STRING
            {
                ...
                final int valueright = ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).right;
                final String value = (String) ((java_cup.runtime.Symbol) CUP$PhpAstParser$stack
                        .elementAt(CUP$PhpAstParser$top - 0)).value;
                RESULT = value;
                CUP$PhpAstParser$result = new java_cup.runtime.Symbol(
                        72/* string_st */,
