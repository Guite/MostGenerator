...
public class CatchClause extends Statement {
    ...
    public CatchClause(int start, int end, AST ast, Expression className,
            Variable variable, Block statement) {
        super(start, end, ast);
    ...
    ASTNode clone0(AST target) {
        ...
        final CatchClause result = new CatchClause(this.getStart(),
                this.getEnd(), target, className, variable, body);
        return result;
    }
