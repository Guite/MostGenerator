...
public class SingleFieldDeclaration extends ASTNode {
    ...
    public static final ChildPropertyDescriptor NAME_PROPERTY = new ChildPropertyDescriptor(
            ...
            "name", Variable.class, MANDATORY, NO_CYCLE_RISK); //$NON-NLS-1$
    public static final ChildPropertyDescriptor VALUE_PROPERTY = new ChildPropertyDescriptor(
            SingleFieldDeclaration.class,
            "value", Expression.class, OPTIONAL, CYCLE_RISK); //$NON-NLS-1$
    ...
    public SingleFieldDeclaration(int start, int end, AST ast, Variable name,
            Expression value) {
        super(start, end, ast);
    ...
    ASTNode clone0(AST target) {
        ...
        final SingleFieldDeclaration result = new SingleFieldDeclaration(
                getStart(), getEnd(), target, name, value);
        return result;
    }
