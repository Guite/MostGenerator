...
public class ConstantDeclaration extends Statement {
    ...
    private ConstantDeclaration(int start, int end, AST ast,
        ...
        final Iterator<Identifier> iteratorNames = names.iterator();
        final Iterator<Expression> iteratorInitializers = initializers
                .iterator();
    ...
    public ConstantDeclaration(int start, int end, AST ast,
        ...
        for (final Iterator iter = variablesAndDefaults.iterator(); iter
                .hasNext();) {
            final ASTNode[] element = (ASTNode[]) iter.next();
    ...
    public void childrenAccept(Visitor visitor) {
        final Iterator<Identifier> iterator1 = names.iterator();
        final Iterator<Expression> iterator2 = initializers.iterator();
