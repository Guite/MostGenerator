...
public class FormalParameter extends Argument {
    ...
    public void traverse(ASTVisitor visitor) throws Exception {
        ...
        if (visit) {
            ...
            final Expression defaultValue = (Expression) getInitialization();
