...
public class PostfixExpression extends Expression implements IOperationNode {
    ...
    public PostfixExpression(int start, int end, AST ast,
            VariableBase variable, int operator) {
        super(start, end, ast);
    ...
    public void setVariable(VariableBase variable) {
        ...
        final ASTNode oldChild = this.variable;
    ...
    ASTNode clone0(AST target) {
        final VariableBase variable = ASTNode.copySubtree(target,
                this.getVariable());
        final PostfixExpression result = new PostfixExpression(this.getStart(),
