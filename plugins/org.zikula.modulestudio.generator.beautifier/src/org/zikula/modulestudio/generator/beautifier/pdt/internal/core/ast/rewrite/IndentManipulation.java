...
public final class IndentManipulation {
    ...
    public static int measureIndentUnits(CharSequence line, int tabWidth,
        ...
        final int visualLength = measureIndentInSpaces(line, tabWidth);
    ...
    public static int measureIndentInSpaces(CharSequence line, int tabWidth) {
        ...
        for (int i = 0; i < max; i++) {
            ...
            if (ch == '\t') {
                final int reminder = length % tabWidth;
    ...
    public static String extractIndentString(String line, int tabWidth,
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (c == '\t') {
                final int remainder = spaceEquivs % tabWidth;
    ...
    public static String trimIndent(String line, int indentUnitsToRemove,
        ...
        for (int i = 0; i < size; i++) {
            final char c = line.charAt(i);
            if (c == '\t') {
                final int remainder = spaceEquivalents % tabWidth;
            ...
            if (spaceEquivalents > spaceEquivalentsToRemove) {
                ...
                final char[] missing = new char[spaceEquivalents
    ...
    public static String changeIndent(String code, int indentUnitsToRemove,
        ...
        try {
            ...
            for (int i = 0; i < nLines; i++) {
                ...
                final String line = code.substring(start, end);
    ...
    public static ReplaceEdit[] getChangeIndentEdits(String source,
        ...
        try {
            ...
            for (int i = 1; i < nLines; i++) {
                ...
                final String line = source.substring(offset,
        ...
        } catch (final BadLocationException cannotHappen) {
            // can not happen
        }
    ...
    private static int indexOfIndent(CharSequence line,
        ...
        final int spaceEquivalents = numberOfIndentUnits * indentWidth;
        ...
        for (int i = 0; i < size && blanks < spaceEquivalents; i++) {
            final char c = line.charAt(i);
            if (c == '\t') {
                final int remainder = blanks % tabWidth;
    ...
    public static int getIndentWidth(Map options) {
        ...
        final int tabWidth = getTabWidth(options);
