...
public final class TextSequenceUtilities {
    ...
    public static TextSequence createTextSequence(
        ...
        final Segment segment = new Segment(s.toCharArray(), 0, s.length());
    ...
    public static String getType(TextSequence textSequence, int index) {
        final int sourceOffset = textSequence.getOriginalOffset(index);
    ...
    public static String getTypeByAbsoluteOffset(TextSequence textSequence,
        ...
        final ITextRegion tRegion = source
                .getRegionAtCharacterOffset(sourceOffset);
        if (tRegion == null) {
            return null;
        }
    ...
    private static class SimpleTextSequence extends AbstractTextSequence
        ...
        public TextSequence cutTextSequence(int start, int end) {
            ...
            final int[] newIndexes = new int[] { offset, start, offset + end,
                    length - end };
    ...
    private static class CompositeTextSequence extends AbstractTextSequence
        ...
        public TextSequence subTextSequence(int start, int end) {
            ...
            final int newNumberOfParts = endPart - startPart + 1;
            if (newNumberOfParts == 1) {
                final int newStart = indexes[(startPart << 1)] + start
                        - startPartLength;
            ...
            final int[] newIndexes = new int[newNumberOfParts << 1];
        ...
        public TextSequence cutTextSequence(int start, int end) {
            ...
            final int numberOfParts = indexes.length >> 1;
            final int newNumberOfParts = startPart + numberOfParts - endPart
                    + 1;
            final int[] newIndexes = new int[newNumberOfParts << 1];
            int part;
            ...
            part++;
            final int diff = numberOfParts - newNumberOfParts;
