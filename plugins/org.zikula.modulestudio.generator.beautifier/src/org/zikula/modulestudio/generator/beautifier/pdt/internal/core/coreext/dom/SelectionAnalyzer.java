...
public class SelectionAnalyzer extends ApplyAll {
    ...
    private final Selection fSelection;
    ...
    public IRegion getSelectedNodeRange() {
        ...
        final ASTNode firstNode = fSelectedNodes.get(0);
        final ASTNode lastNode = fSelectedNodes.get(fSelectedNodes.size() - 1);
        final int start = firstNode.getStart();
