...
public class UseStatement extends Statement {
    ...
    public UseStatement(int start, int end, AST ast, List parts) {
        ...
        final Iterator<UseStatementPart> it = parts.iterator();
        while (it.hasNext()) {
    ...
    public UseStatement(int start, int end, AST ast, UseStatementPart[] parts) {
        ...
        for (final UseStatementPart part : parts) {
            this.parts.add(part);
        }
    }
    ...
    public void childrenAccept(Visitor visitor) {
        for (final ASTNode node : this.parts) {
            node.accept(visitor);
        }
    }
    ...
    public void toString(StringBuffer buffer, String tab) {
        ...
        buffer.append(">\n");
        for (final UseStatementPart part : this.parts) {
