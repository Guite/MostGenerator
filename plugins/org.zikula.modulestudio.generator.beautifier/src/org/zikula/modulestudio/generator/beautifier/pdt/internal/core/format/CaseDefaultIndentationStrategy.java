...
public class CaseDefaultIndentationStrategy implements IIndentationStrategy {
    ...
    public void placeMatchingBlanks(IStructuredDocument document,
        ...
        if (indentationBase != null) {
            ...
            if (addIndentation) {
                final int indentationSize = FormatPreferencesSupport
                        .getInstance().getIndentationSize(document);
                final char indentationChar = FormatPreferencesSupport
                        .getInstance().getIndentationChar(document);
