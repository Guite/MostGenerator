...
public class StaticStatement extends Statement {
    ...
    private StaticStatement(int start, int end, AST ast,
    ...
    public Variable[] getVariables() {
        ...
        for (final Expression node : this.expressions) {
    ...
    ASTNode clone0(AST target) {
        final List expressions = ASTNode.copySubtrees(target,
                this.expressions());
        final StaticStatement staticStatementSt = new StaticStatement(
