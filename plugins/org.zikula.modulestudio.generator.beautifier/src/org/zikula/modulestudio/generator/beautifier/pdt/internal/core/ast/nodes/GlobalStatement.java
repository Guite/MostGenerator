...
public class GlobalStatement extends Statement {
    ...
    private final ASTNode.NodeList<Variable> variables = new ASTNode.NodeList<Variable>(
            VARIABLES_PROPERTY);
    ...
    public GlobalStatement(int start, int end, AST ast, List variables) {
        this(start, end, ast, variables == null ? null : (Variable[]) variables
    ...
    ASTNode clone0(AST target) {
        ...
        final GlobalStatement result = new GlobalStatement(this.getStart(),
                this.getEnd(), target, variables);
        return result;
    }
