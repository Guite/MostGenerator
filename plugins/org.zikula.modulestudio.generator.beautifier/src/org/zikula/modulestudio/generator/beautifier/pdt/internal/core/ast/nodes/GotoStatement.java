...
public class GotoStatement extends Statement {
     ...
     */
    public static final ChildPropertyDescriptor LABEL_PROPERTY = new ChildPropertyDescriptor(
            GotoStatement.class,
    ...
    public void setLabel(Identifier label) {
        ...
        final ASTNode oldChild = this.label;
    ...
    ASTNode clone0(AST target) {
        ...
        final GotoStatement result = new GotoStatement(this.getStart(),
                this.getEnd(), target, label);
        return result;
    }
