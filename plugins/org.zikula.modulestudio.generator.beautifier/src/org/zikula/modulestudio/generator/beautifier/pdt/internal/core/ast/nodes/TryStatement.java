...
public class TryStatement extends Statement {
    ...
    private final ASTNode.NodeList<CatchClause> catchClauses = new ASTNode.NodeList<CatchClause>(
    ...
    public void childrenAccept(Visitor visitor) {
        ...
        for (final ASTNode catchClause : this.catchClauses) {
    ...
    public void setBody(Block body) {
        ...
        final ASTNode oldChild = this.tryStatement;
