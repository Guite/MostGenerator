 ...
 * }
 */
public class NamespaceDeclaration extends TypeDeclaration implements
    ...
    public NamespaceDeclaration(int start, int end, int nameStart, int nameEnd,
            String className, Block body, PHPDocBlock phpDoc) {
